...
This version of **Warhammer Fantasy Roleplay** is compatible with adventures, supplements, and other publications released for Warhammer Fantasy Roleplay Fourth Edition. Here are the chief changes to be aware of when using older material.

# **Creature Traits**

NPC stat blocks remain largely unchanged between versions. Use the Creature Traits and Talents presented in this rulebook.

# **Advantage and Momentum**

In this edition, Advantage refers to swapping the results of a die role when doing so would benefit you. When older materials refer to Advantage, it means Momentum. If an ability or effect would cause a creature to gain any amount of Advantage, they gain Momentum instead. If it would cause them to lose any amount of Advantage, they lose Momentum instead. If an expenditure of Advantage is required, that creature loses Momentum instead.
...
|------------------|--------------------|--|
| Very Easy (+60)  | Very Easy (+6 SL)  |  |
| Easy (+40)       | Easy (+4 SL)       |  |
| Average (+20)    | Average (+2 SL)    |  |
| Challenging (+0) | Challenging (+ SL) |  |
| Difficult (-10)  | Difficult (-1 SL)  |  |
| Hard (-20)       | Hard (-2 SL)       |  |
| Very Hard (-30)  | Very Hard (-3 SL)  |  |
|                  |                    |  |

# **Resilience and Resolve**

These attributes are no longer part of the game. If an effect refers to Resilience, use Fate instead. If it refers to Resolve, use Fortune instead. If a rule obliges you to remove a permanent point of Resilience, reduce your maximum Fortune by 1 under the same conditions.
...
| 11–20          | Jarred Arm              | 0      | Drop anything held in that hand, which is useless for 1d10 – TB Rounds (minimum<br>1). For this time, treat the hand as lost (see Amputated Parts, page 178).                                                                                                                                   |
...
| 51–55          | Wrenched Arm            | 2      | Drop any item held in that hand. The arm is useless for 1d10 Rounds (see<br>Amputated Parts, page 178).                                                                                                                                                                                         |
...
| 96–109         | Dislocated<br>Shoulder  | 4      | The arm is useless until the shoulder is reset (see Amputated Parts, page 178). An<br>Extended Average (+2 SL) Heal Test reaching 6 SL resets the arm. After this, for<br>1d10 days, Tests made using the arm suffer a -1 SL penalty.                                                           |
...
| 51–55          | Wrenched Collar<br>Bone       | 2      | Randomly select one arm. Drop whatever is held in that hand; the arm is useless for<br>1d10 Rounds (see Amputated Parts, page 178).                                                                                                                                      |
...
| 86–95          | Dislocated Knee       | 4      | Gain the Prone Condition and your leg is useless (see Amputated Parts, page 178)<br>until the knee is reset. An Extended Average (+2 SL) Heal Test reaching 6 SL resets<br>the knee, with one Test made each Round. After this, for 1d10 days, Movement is<br>halved.                    |
...
| Channelling<br>Charm | WP<br>Fel | B   | AG Summon arcane power<br>Get your way |
