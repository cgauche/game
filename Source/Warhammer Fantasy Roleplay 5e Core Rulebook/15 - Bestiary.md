...
> — Dr. Heironymous Blitzen, Professor of Bestiaria, University of Altdorf

Many terrible and wondrous creatures dwell in the wild places of the Empire and beyond its borders. No less deadly are those threats originating in the cities, towns, and villages of those we tend to assume are our friends, countrymen, or allies. This bestiary gives you game information for a range of opponents, associates, or passers-by the Characters might encounter in the course of their adventures.

# **Customising Creatures**

The information presented is for the basic example of each particular individual. You can adapt these entries for variety, or to create more powerful creatures, by changing their Characteristics and adding Skills, Talents, and Creature Traits. The quickest way to create fast NPC adversaries is to use Creature Traits; all creatures come with one or more Creature Traits as standard, but additional ones can be added as required. The listed Optional Traits for a creature present common variants of the species, but you can apply any Trait to any creature if it fits your game. See page 356 for Creature Traits.

The templates on page 353 are a quick way of creating a variety of opponents from more organised species or societies. Apply the template to the basic information for the species to create a Soldier, Skirmisher, Elite, Leader, Commander, Spellcaster, or Spellcaster Lord. You could even use the Career system to develop well rounded and, depending on how much XP you decide to spend on them, terrifyingly powerful allies or antagonists.

#### **CREATURE CHARACTERISTICS**

The Characteristics in the **Bestiary** are average values, rounded to the nearest 0 or 5. To individualise Characteristics, subtract 10 and add 2d10. For example, a Characteristic of 30 becomes 2d10 + 20. You can also use this method to create Player Characters from species normally intended as NPCs by assigning them an appropriate Career — an ogre Soldier, skaven Engineer, or vampire Noble, for example.
...
If an animal has a Hit Location without a Critical Table, such as a tentacle, tail, or wing, roll on the Arm table and describe the results in an appropriate way.

# **Creatures and Equipment**

Melee weapons are listed in a creature's attacks showing the weapon's name, its Skill with that weapon and the total Damage it inflicts (the creature's Strength Bonus is included) in parentheses, followed by any Qualities or Flaws in italics. For example, a spear-armed creature would have: **Spear**  (30/+7) *Impale*.

Ranged weapons are listed with the weapon and ammunition it uses, followed by parentheses containing the creature's Skill with that weapon and the total Damage it inflicts (appropriate Strength Bonus is included), its range in yards, and any Qualities or Flaws in italics. For example, a creature armed with a Bow and Arrows would have: **Bow and Arrows** (30/+7) 50 yards, *Impale*.

Many creatures are armed with teeth, claws, horns, or other natural weaponry as their primary weapon. Unless otherwise mentioned, the Reach of such weapons is Personal and they possess no Qualities or Flaws.

Where an *Armour* value is provided, the total Toughness Bonus + Armour Points is shown in parentheses.
...
**Optional Bow and Arrows:** (35/+7) 50 yards, *Impale*
...
**Optional Sling and Bullets:** (40/+6) 60 yards, *Pummel*
...
Charm 45, Dodge 35, Perception 55, Sleight of Hand 45, Stealth (Urban) 35
...
**Optional Crossbow and Bolts:** (30/+9)

50 yards, *Impale*, *Reload 3*
...
Consume Alcohol 45, Endurance 45, Evaluate 35, Lore (Dwarfs) 35, Melee (Basic) 45
...
**Magic Resistance:** Any spell that targets them suffers -3 SL
...
**Optional Longbow and Elf Arrows:**

(45/+7) 70 yards, *Impale*
...
Cool 45, Melee (Basic) 45, Navigation 55, Perception 55, Ranged (Bow) 45
...
**Leather Jack:** +1 AP to Arms and Body

### **Skills**

Athletics 40, Cool 40, Dodge 40, Gossip 40, Haggle 35, Intimidate 45, Melee (Basic) 55, Perception 50, Ranged (Bow) 35

#### **Talents**

**Acute Sense (Sight):** May take Perception

Tests to detect normally imperceptible details with the associated sense

**Nose for Trouble:** Advantage on Intuition Tests, and can usually tell where to gamble, fight, or get stinking drunk

**Supportive:** Advantage and no penalty on Tests to Charm those of higher Status

**Warrior Born:** +5 WS already added to profile

#### **Talents**

Cloak, Clothing, Copper Badge, Dagger, Hand Weapon, Lamp Oil, Lantern and Pole, Leather Jack, Hat, Pouch containing 1d10 Silver Shillings, Sling Bag containing Lunch, Uniform

# **Human Merchant**

Merchants are commonly encountered wherever goods are bought and sold. This profile suits market traders, but can easily be adapted for shopkeepers, innkeepers, and other vendors by adjusting the Trappings.
...
Animal Care 45, Charm 50, Charm Animal 40, Drive 45, Evaluate 50, Gossip 55, Haggle 55, Intuition 35, Melee (Basic) 35, Navigation 45
...
**Suave:** +5 Fel already added to profile
...
Charm 35, Consume Alcohol 45, Cool 40, Dodge 35, Gamble 35, Gossip 35, Haggle 35, Intimidate 55, Melee (Basic) 50, Melee (Brawling) 45, Stealth (Urban) 35
...
**Very Strong:** +5 S already added to profile
...
**Leather Jerkin:** +1 AP to Body

#### **Skills**

Athletics 45, Climb 35, Dodge 50, Intuition 60, Melee (Basic) 25, Perception 65, Pick Lock 55, Sleight of Hand 55, Stealth (Urban) 50
...
**Flee!:** Tests to flee as the Quarry in a Pursuit benefit from +1 SL

**Night Vision:** See clearly for 20 yards and extend the illumination distance of light sources by 20 yards

**Resistance (Chaos):** Automatically pass first Test to resist Corruption each session, Advantage on all further such Tests
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 4 | 40 | 30 | 30 | 20 | 30 | 40 | 40  | 30  | 40 | 25  | 11 |
...
Charm Animal 45, Melee (Basic) 45, Stealth (Rural) 40
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 6 | 30 | 20 | 45 | 45 | 20 | 25 | 20  | 20  | 30 | 20  | 30 |
...
Consume Alcohol 55, Endurance 55, Melee 40

#### **Traits**

**Fear:** Opponents cannot gain Momentum, Cool Test to overcome
...
*'Yes, I summoned them because I needed reinforcements. Yes, I know they are eating your prize cattle. And, yes, I know Ogres have large appetites.'*

— Augustus von Raushvel, Baron of Raush Vale

### **HALFLINGS AND OGRES**

No one knows why, but halflings and ogres share a curious affinity. Many halfling clan elders employ ogre bodyguards, and it is said the Grand Elder of the Moot rarely travels without his old friend Zorarth Legbiter, a hoary ogre who has lived in the Empire for almost a century. In return, many ogre mercenary bands employ halfling cooks. The arrangement does not always end well, however. Golgfag Maneater, captain of the imaginatively named Golgfag's Maneaters, once employed a small halfling clan to feed his regiment after a great victory. The arrangement worked perfectly — until Golgfag discovered the cooks tasted even better than the meals they prepared.
...
Melee (Brawling) 40, Perception 40, Stealth (Rural) 40
...
**Bite:** (25/+5) Lose Momentum to make this Free Attack
...
Dodge 35, Perception 40, Track 45
...
*Frenzy, Infected, Size (Average), Territorial, Trained (Broken, Drive, Entertain, Fetch, Guard, Magic, War)*
...
**Bite:** (30/+5) Lose Momentum to make this Free Attack
...
Melee (Brawling) 30, Perception 45, Stealth 40
...
*Disease (Black Plague, Ratte Fever), Size (Average), Swarm, Trained (War)*
...
**Bite:** (40/+4) Lose Momentum to make this Free Attack

**Attacks**

#### **Skills**

Dodge 40, Melee (Brawling) 40, Stealth 40
...
*Trained (Broken, Drive, Entertain, Magic, Mount, War)*
...
**Bite:** (35/+6) Lose Momentum to make this Free Attack
...
Melee (Brawling) 35, Perception 45, Track 45
...
*Frenzy, Infected, Size (Large), Territorial, Trained (Broken, Drive, Fetch, Guard, Magic, War)*
...
**8 Tentacles:** (40/+8) The creature may make 8 free attacks, if they cause Damage they can also give their opponent an *Entangled* Condition
...
Climb 65, Melee (Brawling) 40, Stealth (Rural) 65, Swim 90

#### **Traits**

**Amphibious:** The creature has the Swim skill and adds +1 SL to all Swim Tests and move at full Movement through water
...
*Size (Enormous or Monstrous), Territorial*

*'Yes, I share your suspicions of what became of Pieter and Dorri, but Graf Boris demands one of these for his Mitterfruhl feast, so by Ulric we will endeavour to press on and find one. Look out for herbs while you're at it. Goes well with a pinch of tarrabeth, apparently.'*
...
**Bite:** (50/+8) Lose Momentum to make this

Free Attack, and has the Penetrating
...
Athletics 55, Endurance 45, Melee (Brawling) 50
...
*'To expect an orc to do ought but fight is folly. To expect a beastman to do ought but pillage is folly. To expect a troll to do ought but kill and eat you is folly. A dragon? Stories say they have accord with the elves, or direct the governance of distant Grand Cathay. One of their kind resides at the Imperial Zoo and consents to be ridden. Yet others would lay waste to an entire province. One can hold no expectation of a dragon.'*

> — Professor Albrecht Ruhmacht, on the nature of dragons
...
**Bite:** (70/+9) Lose Momentum to make this

Free Attack, and has the *Penetrating*

**Tail:** (70/+8) Lose Momentum to make this Free Attack, smaller opponents take a *Prone* Condition if wounded

**Breath (Any One):** See page 357 for details of breath attacks
...
Melee (Brawling) 70, Perception 70, Tracking 70
...
**Size (Enormous):** See page 360 for implications of size
...
Endurance 65, Melee (Brawling) 40
...
**Stupid:** Must pass an **Easy (+4 SL) Intelligence** Test before acting, unless they are directed by a creature without this Trait.

#### **Optional Traits**

 *Frenzy, Hungry, Infestation, Territorial*

*'Something of a paradox to consider whether or not it is alive. It is made of life, so scholars of magic assure us, and consists in no small part of living things — deprive it of worms, moss, and mould, and it barely has a corpus. Yet, is it alive? In that it is itself a living creature? The gods know, but I do not.'*
...
**Scavenged Armour:** +1 AP

**Skills**

Consume Alcohol 60, Melee (Basic) 35
...
Athletics 65, Melee (Brawling) 60, Perception 60
...
*'The nobles of Ostermark flaunt the Manticore's heraldry, unaware it embodies Chaos, hunger, and blood defiled. I warn you, its roar carries an echo of the wind of Shyish. Should you ever spy one aloft pray that it passes you by, for no mortal plea or charm can keep you safe.'*
...
*'Ayup, the fields certainly are lush 'round these parts, as it 'appens. It's the pegasi, or pegasuses, or whatever they're called. I need to procure no manure for fertiliser, it just drops from the 'eavens, like a sloppy, wet gift from Mother Rhya 'erself. Mind you, you don't wanna be standin' underneath a band of the* 

*beasts when they fly over. That can be messy. Really messy'*
...
There are a number of species of trolls so you should feel free to customise them at will. Some of the trolls most likely to trouble parties in the Reikland include:

**Chaos Trolls:** These bear one or more Mutations, gifts of the Dark Gods that make them especially dangerous and unpredictable. Such unfortunate creatures are often pressed into the service of marauding Chaos warbands or beastman warherds. The more severely mutated the troll, the greater the perceived favour of the Ruinous Powers — and the more highly prized it is by its masters.

**River Trolls:** Skulking in the stagnant, foetid marshes of the Reik, river trolls are an unfortunately common sight. They are opportunistic hunters, using their weed-like hides as camouflage while they float like clumps of weed or flotsam, or lie in wait in muddy banks waiting for small boats or unwary travellers.

**Stone Trolls:** Rarely seen beyond the Empire's mountain ranges, stone trolls make their lairs in caves and are among the most common hazards faced by those crossing the Grey Mountains. Their hides have ossified into rough, stone-like plates that protect them from harm while blending almost seamlessly into the surrounding rock.
...
Melee (Brawling) 40, Melee (Basic) 45, Endurance 55
...
*Amphibious, Bestial, Corruption (Minor), Frenzy, Hungry, Infestation, Magic Resistance 2, Mutation, Night Vision, Painless, Stealthy, Striding Gait (Mountains, Underground, Wetlands)*
...
Scrawny, spiteful, nimble, and possessed of a degree of mean cunning, a goblin's instinct for self preservation should never be underestimated. Though cowardly, they readily band together if this secures an overwhelming advantage in numbers. Goblins frequently join with orc armies — not always by choice — opportunistically helping themselves to the spoils of war while others do most of the actual fighting.

# *'Where is they? Where is they? Where is his eyes?'*
...
**Optional Shortbow and Arrows:**

(35/+6) 40 yards, *Impale*
...
Dodge 35, Melee (Basic) 30, Perception 25, Ranged (Bow) 35, Stealth (Rural) 35, Stealth (Underground) 35
...
Endurance 50, Melee (Basic) 40, Ranged (Bow) 35
...
*'We iz the best. We iz not dem weedie gobbos or stoopid trollz, we iz well 'ard! An' if anywun sayz we ain't, we iz gunna stomp on der edz an' we ain't gunna stop stompin' until dey is ded!'*
...
**Knife:** (20/+3) *Undamaging*

**Optional Rocks:** (20/+2) 6 yards, *Undamaging*
...
Melee (Brawling) 35, Stealth 40, Track 40
...
**Painless:** All non-amputation penalties suffered from Critical Wounds are ignored

**Undead:** Not reliant on air, food, water, and other things needed to sustain life, affected by spells, miracles, or other abilities that affect *Undead* only

**Unstable:** If the creature ends a Round Engaged with opponents who possess Advantage when they do not, they are driven back, and they lose 2 Wounds

#### **Optional Traits**

*Corruption (Minor), Infected, Territorial*
...
Any undead creature with the Construct Trait is magically bound together with sinews of dark magics. They are either mindless automatons reanimated by a necromancer, or those who came to unlife in a place where Shyish, the magical Wind of Death, or Dhar, vile Black Magic, gathers and stagnates, twisting death into something new.

#### **ZOMBIE**

| M | WS | BS | S  | T  | I | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|---|----|-----|-----|----|-----|----|
| 4 | 15 | –  | 30 | 30 | 5 | 10 | 10  | –   | –  | –   | 12 |

#### **Attacks**

**Hand Weapon:** (25/+7) Magical

**Bite:** (30/+6) Lose Momentum to make this Free Attack
...
Melee (Basic) 25, Melee (Brawling) 30
...
**Painless:** All non-amputation penalties suffered from

Critical Wounds are ignored
...
**Bite:** (40/+6) Lose Momentum to make this Free Attack
...
Cool 15, Melee (Brawling) 40, Track 10
...
Dodge 40, Melee (Brawling) 40

#### **Traits**

**Dark Vision:** See in the dark as daylight

**Ethereal:** Insubstantial, can only be harmed by Magical attacks
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 6 | 35 | –  | 35 | 30 | 25 | 30 | 25  | 25  | 25 | 15  | 11 |
...
Melee (Brawling) 40, Melee (Two-handed) 45

#### **Traits**

**Champion:** If the creature wins an Opposed Test when defending in melee combat, they can cause Damage as if they were the attacker
...
**Terror 3:** The creature causes *Terror*, see page 184 for details
...
**Hand Weapon:** (45/+7) *Magical*

**Ghostly Howl:** Lose Momentum to make Free Attack. All living targets within 30 yards gain 3 *Deafened* Conditions and suffer 1d10 Wounds ignoring Toughness Bonus and Armour Points. Those affected must also pass an **Average (+2 SL) Cool** Test or gain a *Broken* Condition. This attack is *Magical*.
...
**Optional Medium Armour:** +3 AP **Optional Heavy Armour:** +5 AP
...
Charm 35, Climb 60, Intuition 50, Melee (Basic) 55, Melee (Brawling) 60, Perception 50, Stealth (Rural) 60, Stealth (Urban) 60, Track 40
...
**Vampiric:** Whenever the creature performs a successful Bite attack against an appropriate opponent, they heal as many Wounds as the opponent loses. Drinking blood in this way is the only way they can heal.
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 8 | 55 | –  | 55 | 55 | 20 | 50 | –   | 10  | 25 | –   | 32 |

#### **Attacks**

**Claws:** (65/+14)

**Bite:** (65/+8) Lose Momentum to make this Free Attack
...
Climb 65, Melee (Brawling) 65, Perception 30, Stealth (Rural) 60, Stealth (Urban) 60, Track 20
...
**Hatred (Living):** Must attack by fastest and most deadly means possible, +1 SL on Melee and Ranged Tests, immune to *Intimidate* and *Fear* caused by them
...
**Terror 3:** The creature causes *Terror*, see page 184 for details **Undead:** Not reliant on air, food, water, and other things needed to sustain life, affected by spells, miracles, or other abilities that affect *Undead* only

**Vampiric:** Whenever the creature performs a successful Bite attack against an appropriate opponent, they heal as many Wounds as the opponent loses. Drinking blood in this way is the only way they can heal damage from fire.

#### **Optional Traits**

*Corruption (Minor), Fly 80, Frenzy, Territorial, Tracker*
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 35 | 30 | 35 | 40 | 30 | 35 | 20  | 20  | 30 | 10  | 14 |

#### **Attacks**

**Hand Weapon:** (45/+7)

**Horns:** (35/+7) Free Attack only when Charging
...
*Corruption (Minor), Disease (Packer's Pox), Infected, Infestation, Mark of Chaos, Mutation*

### **UNGOR**

| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 30 | 30 | 30 | 35 | 30 | 35 | 30  | 20  | 25 | 10  | 11 |
...
Melee (Basic) 35, Perception 35, Track 40, Ranged (Bow) 40, Stealth (Rural) 40
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 6 | 45 | 25 | 45 | 45 | 20 | 35 | 10  | 15  | 35 | 10  | 30 |

#### **Attacks**

**Hand Weapon:** (55/+12)

**Horns:** (45/+8) Free Attack only when Charging
...
Cool 40, Endurance 50, Melee (Basic) 55
...
*Belligerent, Corruption (Minor), Disease (Packer's Pox), Frenzy, Infected, Infestation, Mutation*

*''They are fell beasts, and swift of axe, they are also slow of thought and easily tricked. You can use their great hunger for blood against them by pulling them into your traps and ambushes. Be careful, though. For every ten of the hulking brutes you face, you will find one that stands out from the herd, being favoured by the blasphemous gods they worship. Do not despair though, in the end, tainted or not, they are still just beasts.''*
...
Melee (Basic) 35, Ranged (Bow) 35, Secret Signs (Cult) 40
...
Melee (Basic) 35, Stealth (Rural) 40, Stealth (Urban) 40
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 4 | 50 | 30 | 45 | 45 | 45 | 40 | 30  | 30  | 55 | 30  | 17 |
...
Cool 65, Dodge 50, Endurance 55, Melee (Basic) 60

#### **Traits**

**Champion:** If the creature wins an Opposed Test when defending in melee combat, they can cause Damage as if they were the attacker

**Corruption (Minor):** Is a Corrupting Influence with a Strength of Minor

#### **Optional Traits**

*Belligerent, Disease (Various), Distracting, Frenzy, Mark of Chaos, Mental Corruption, Mutation*

> *'In the dreaded north lies the greatest danger. It is the product of another place, another time, released upon us by the misfortune and mistake of long-dead gods. It hungrily grasps for our world, quivering with expectation, sending forth hordes of the most warlike and jealous people of them all: our own kin, the tribes of man.'* — Phitzer, Wissenlander Witch
...
Daemons cannot manifest for long, because the material world itself rejects them. The havoc they wreak before being banished is so profound, however, that none who encounter a daemon ever forget the mind-fracturing experience.

### **BLOODLETTER OF KHORNE**

| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 55 | 55 | 45 | 35 | 45 | 45 | 30  | 25  | 70 | 15  | 17 |

#### **Attacks**

**Hellblade:** (65/+9) *Damaging, Impact, Magical*

**Horns:** (55/+8) Free Attack only when Charging, *Magical*
...
Cool 80, Melee (Two-handed) 60, Perception 50

#### **Traits**

**Champion:** If the creature wins an Opposed Test when defending in melee combat, they can cause Damage as if they were the attacker

**Corruption (Moderate):** Is a Corrupting Influence with a Strength of Moderate

**Daemonic 8+:** Not reliant on air, food, water, and other things needed to sustain life. Roll 1d10 after any blow is received: if the creature rolls 8 or higher, the blow is ignored, even if it is a Critical. They may not use this ability to ignore *Magical* blows. If reduced to 0 Wounds, the creature is removed from play.
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 50 | 45 | 35 | 35 | 55 | 60 | 30  | 30  | 70 | 45  | 16 |

#### **Attacks**

**Claws:** (55/+9) *Fast, Penetrating, Magical*
...
Charm 55, Cool 80, Dodge 70, Melee (Brawling) 55, Perception 60
...
**Mark of Chaos (Slaanesh):** See page 359 for details

**Painless:** All non-amputation penalties suffered from Critical Wounds are ignored

**Unstable:** If the creature ends a Round Engaged with opponents who possess Advantage when they do not, they are driven back, and they lose 2 Wounds

*'Come stranger, and rest with us a while, for everyone who enjoys our company and heeds our sweet song benefits greatly from the experience. Is there anything you might like to know? Anything you might like to feel? Anything you might like to become? Heed our sweet song, and you will never regret it.'.'*

— A promise made to those who are unwary of traps
...
Skaven society is built upon the labour of captives taken from across the Old World, and their network of spies and informants is vast. The unscrupulous supply prisoners and warpstone to the skaven in exchange for secret knowledge and other unsavoury favours.

The skaven know their survival depends upon secrecy and protect it ruthlessly. Those foolish enough to speak openly of a civilisation of intelligent ratmen beneath the Empire's cobbled streets may soon be found dead in a gutter, the unfortunate victim of an unlikely accident.
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 30 | 30 | 30 | 30 | 40 | 35 | 30  | 20  | 20 | 15  | 11 |
...
Athletics 40, Climb 40, Dodge 40, Melee (Basic) 35, Perception 45, Track 50, Stealth (Underground) 40, Stealth (Urban) 40

#### **Traits**

**Infected:** Wounded opponents must take an **Easy (+4 SL) Endurance** Test to avoid a Festering Wound **Night Vision:** See clearly for 20 yards and extend the illumination distance of light sources by 20 yards **Striding Gait (Underground):** Suffer no penalties for moving underground and +1 SL to all Athletics and

#### **Optional Traits**

Stealth Tests when underground
...
The Stormvermin has been created by adding the Elite template (see page 353) to the basic Clanrat profile.

### **STORMVERMIN**

| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 45 | 30 | 45 | 45 | 55 | 45 | 30  | 20  | 35 | 15  | 15 |

#### **Attacks**

**Halberd:** (60/+8) *Defensive, Hack, Impale*
...
**Infected:** Wounded opponents must take an Easy (+4 SL) Endurance Test to avoid a Festering Wound **Night Vision:** See clearly for 20 yards and extend the illumination distance of light sources by 20 yards **Striding Gait (Underground):** Suffer no penalties for moving underground and +1 SL to all Athletics and Stealth Tests when underground
...
Rat ogres are hulking brutes, bred in the dark caverns of the Under-empire by the demented ministerings of Clan Moulder's master mutators. They are stupid, but when driven by their skaven masters are fearless and unrelenting in combat. Rarely encountered on their own, they tend to accompany ranking skaven as bodyguards.

#### **RAT OGRE**

| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 35 | 10 | 55 | 45 | 35 | 45 | 25  | 10  | 25 | 10  | 30 |
...
Climb 60, Endurance 60, Melee (Brawling) 50
...
Channelling (Any) +10, Cool +10, Dodge +10, Intuition +10, Language (Magick) +15, Melee (Basic or Polearm) +10, Perception +10

#### **Talents**

Aethyric Attunement or Instinctive Diction, Arcane Magic (Any) or Chaos Magic (Any), Petty Magic, Second Sight
...
Aethyric Attunement, Arcane Magic (Any) or Chaos Magic (Any), Instinctive Diction 2, Luck, Magical Sense, Menacing, Petty Magic, Second Sight, Sixth Sense
...
# **Skrakk - Bestigor (Elite)**

Skrakk is the lieutenant of Ungrakk, the beastlord, though he grows impatient looking for a fight. Beyond bellowing a war cry and leading the charge, he does little to organise or inspire the brayherd. Fortunately for Skrakk, this style of command earns him considerable respect amongst the beastmen.

#### **SKRAKK - BESTIGOR (ELITE)**

| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 50 | 30 | 50 | 55 | 45 | 35 | 20  | 20  | 45 | 10  | 19 |
...
Cool 60, Dodge 50, Intimidate 60, Leadership 15, Melee (Basic 65, Two-Handed 65), Perception 60
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 55 | 50 | 55 | 50 | 50 | 45 | 20  | 20  | 50 | 25  | 20 |

#### **Attacks**

**Hand Weapon:** (75/+9)

**Horns:** (55/+9) Free Attack only when Charging
...
Cool 70, Dodge 65, Intimidate 75, Leadership 50, Lore (Warfare) 40, Melee (Basic 75, Two-Handed 75), Perception 70

#### **Talents**

**Combat Aware:** Take a Challenging (+0 SL) Perception Test to ignore the Surprised Condition from an ambush

**Combat Reflexes:** Combat Initiative counts as 70

**Furious Assault:** Once per Round, if creature hits opponent in melee, they may lose Advantage to make an extra attack

**Inspiring:** Advantage on Leadership Tests in Combat
...
**War Leader:** Allies influenced with Leadership during battle may use the creature's Leadership rather than their Cool to resist Fear until the end of the battle
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 35 | 30 | 35 | 40 | 40 | 35 | 20  | 30  | 40 | 10  | 15 |
...
Channelling (*Ghur*) 50, Cool 50, Dodge 45, Intuition 50, Language (Magick) 45, Melee (Basic) 45, Perception 50

#### **Talents**

**Arcane Magic (Beasts):** May cast spells from the Lore of Beasts

**Instinctive Diction:** If a Critical Casting Test requires a roll on the **Minor Miscast Table**, the creature may reduce the result by 20, and if the final result is less than 01, no Miscast occurs

**Petty Magic:** May cast Petty Magic spells

**Second Sight:** Can perceive the Winds of Magic
...
| M | WS | BS | S  | T  | I  | Ag | Dex | Int | WP | Fel | W  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 30 | 40 | 30 | 35 | 40 | 45 | 30  | 20  | 35 | 10  | 12 |

#### **Attacks**

**Hand Weapon:** (30/+7)

**Shortbow and Arrows:** (50/+6) 40 yards, Impale
...
Dodge 55, Ranged (Bow) 50, Stealth (Rural) 55

#### **Trappings**

Axe, Shortbow and 10 Arrows

# **CREATURE TRAITS**

### **Afraid (Target)**

The creature gains Fear of the Target. When encountered, they must make an Extended Psychology Test (page 183). Until their SL equals or exceeds the Target's Fear Rating, the creature cannot gain Momentum, and Melee Attacks made against them by the Target benefit from Advantage. See page 183 for *Fear* rules.

### **Amphibious**

The creature is as at home in water as they are on land. They have the Swim Skill, add +1 SL to all Swim Tests, and move at full Movement through water.

### **Animosity (Target)**

The creature dislikes the Target. When the creature encounters the object of its Animosity, make a Psychology Test (page 183). On a failure, it must attack the target socially or physically, as appropriate, gaining +1 SL on Fellowship based Tests to oppose or disparage them. See page 183 for full *Animosity* rules.

### **Belligerent**

The creature loves to win a fight. As long as they possess Momentum, they are immune to *Fear*.

### **Bestial**

The creature has no rational thought or language. It shies away from fire and gains a *Broken* Condition if struck and wounded by it. In defence, it only uses the *Dodge* Skill. If it loses more than half its Wounds, it will attempt to Flee unless protecting its young or cornered, or unless it has the *Territorial* Trait. If so, it enters *Frenzy* (see page 184).

#### **Bite**

The creature may lose Momentum to make a Free Attack. The Damage equals Rating and includes their Strength Bonus already.

**Free Attack** - Weapon Skill or Ballistic Skill attack that does not use your Action on your Turn.
...
The creature is an extraordinarily skilled warrior. If they win an Opposed Test when defending in melee combat, they can cause Damage just as if they were the attacker.
...
The creature can squeeze and crush their prey. Any successful hit gives the target an *Entangled* Condition. The creature may then enter a Grapple if they wish (see page 167).

### **Construct**

The creature is a construct of magic, quite mindless, and bound together with enchantments. It has no Intelligence, Willpower, or Fellowship Characteristics, and need never Test them. If it is ever called upon to Test based on Willpower, use Toughness instead. If it has no spellcaster controlling it, or does not possess the *Territorial* Trait, it wanders mindlessly. For the purpose of calculating its Wounds, use its Strength Bonus whenever Willpower Bonus is required. All its attacks are *Magical*.

### **Corrosive Blood**

The creature's blood is corrosive. Every time they are wounded, blood splashes free and all targets Engaged with them take 1d10 Damage (roll once and apply to all targets).

### **Corruption (Strength)**

The creature is tainted by Chaos, or perhaps suffused with Dark Magics. They are a Corrupting Influence with a Strength marked in parentheses. See page 187.

#### **Dark Vision**

The creature can see in the dark as if it were daylight.

### **Daemonic (Rating)**

The creature's essence is raw magic, and unholy ichor pumps through what passes for their veins. Daemonic creatures do not require the normal prerequisites for life such as food, water, air, and so on.
...
The creature distracts or confuses foes, possibly exuding a soporific musk or nauseating reek, or through its bizarre and horrifying appearance. All living targets within a number of yards equal to the creature's Toughness Bonus suffer a -2 SL penalty to all Tests. A target can only suffer this penalty once, no matter how many *Distracting* foes there are.

### **Ethereal**

The creature's form is insubstantial, allowing them to pass through solid objects. They can only be harmed by *Magical*  attacks and all their attacks are *Magical*.

# **Fear (Rating)**

The creature causes supernatural *Fear* in other creatures. Opponents must make an Extended Psychology Test (page 183). Until they have accumulated more SL than the creature's *Fear* Rating (1, if not stated), they cannot gain Momentum, and melee attacks against them benefit from Advantage. See page 183 for *Fear* rules.

### **Fly (Rating)**

As the creature's Move, they can fly up to Rating yards. When flying, they ignore all intervening terrain, obstacles, or creatures. At the end of the move, they decide whether they have landed or are still flying. They can use this move to Charge. If they start their turn flying, they must choose to Fly for their Move. If they cannot do this, the GM decides how far the creature falls (see page 169).

When targeting them, measure horizontal distance as normal, then increase range by 1 step. So, a Long Range shot would become Extreme Range, and if they were at Extreme Range, they could not be shot at all. When flying, they suffer a -20 penalty to Ranged Attacks as they swoop and wheel in the sky.

### **Frenzy**

The creature may make a Willpower Test to enter a *Frenzy*  (page 184). While *Frenzied*, they are immune to Psychology, cannot flee or retreat, must attack the nearest visible enemy, gain a Free Attack each Round, +1 Damage, and may only attack or move to attack. *Frenzy* ends when no enemies remain in sight, or if the creature becomes *Stunned* or *Unconscious*. Afterwards, they gain a *Fatigued* Condition.

### **Ghostly Howl**

The creature can emit a hideous scream, capable of killing those who hear it. Once per turn, this creature can lose their Momentum to unleash a howl as a Free Attack. All living targets within a number of yards equal to the creature's Strength who can hear it immediately gain 3 *Deafened* Conditions and suffer 1d10 Wounds ignoring Toughness Bonus and Armour Points. Those affected must also pass an **Average (+2 SL) Cool** Test or gain a *Broken* Condition. This attack is *Magical*.

### **Grim**

The creature is incredibly lethal, able to quickly gain the upper hand over almost any opponent. At the end of its turn, if the creature does not have Momentum (page 167), it gains it.

### **Hatred (Target)**

When the creature encounters the Target, they must make a Psychology Test (page 183). On a failure, they become subject to *Hatred*. While *Hatred* lasts, they must attack the hated foe by the fastest and most deadly means possible, gain +1 SL on Melee and Ranged Tests against them, and are immune to *Intimidate* and *Fear* (but not *Terror*) caused by the Target. See page 184 for full *Hatred* rules.

### **Horns**

The creature has horns or some other sharp appendage (if their *Horns* Trait represents a different feature, it will be noted in parentheses). When the creature charges into combat, they may make a Free Attack with their *Horns*, with a Damage of SB +4.

### **Hungry**

The creature is always hungry for fresh meat. If they kill or incapacitate a living opponent (or encounter a fresh body), they must pass an **Average (+2 SL) Cool** Test or feast, losing their next Move and Action.

### **Immune to Psychology**

Whether brave, stupid, or just caught up in the moment, the creature is utterly stoic. They ignore the Psychology rules (see page 183).
...
The creature's hide is infested with biting fleas or similar. All opponents suffer a penalty of -1 SL to hit them in melee combat as the parasites distract and overwhelm them.

### **Many Heads (Number)**

The creature has more than one head. If a Critical Wound affecting the head stuns, kills, or renders the creature unconscious it will only affect the creature once all the heads are either disabled or affected to a similar degree. If the creature has the *Bite*, *Horns*, or *Tongue* Traits it can make a number of Free Attacks equal to the number of healthy heads. The creature benefits from +2 SL to Perception Tests whilst it has at least two healthy heads.

# **Mark of Chaos (God)**

One of the dark powers has marked this creature with a physical brand, proclaiming it one of their favoured servants. The exact effects of this mark depend on which of the Chaos gods bestowed the Mark.
...
> **Tzeentch:** This creature gains 1d10/3 Mutations (rounding up), alternating between Mental and Physical Mutations. This creature gains *Etiquette* (*Followers of Tzeentch*), and is subject to *Animosity* towards overt followers of Nurgle. The creature is also subject to *Animosity* by followers of Nurgle, so long as the Mark of Tzeentch can be seen. Additionally, this creature may purchase the following Talents as if they were Career Advances: *Aethyric Attunement, Arcane Magic (Any), Chaos Magic (Tzeentch), Fast Hands, Instinctive Diction, Magical Sense, Petty Magic, Second Sight, War Wizard*, and *Witch!* for the normal XP costs.

### **Magical**

The creature is wreathed in magic. Their attacks count as Magical, and they can harm creatures only susceptible to *Magical* attacks.

### **Magic Resistance**

The creature is resistant to magic. Any Casting Test to cast a Spell that would affect them suffers -3 SL. No creature with this Trait may possess the Channelling Skill or the *Arcane Magic, Bless, Chaos Magic, Invoke, Petty Magic,* or *Witch!* Talents, and vice versa.

### **Mental Corruption**

The creature has Chaos on the mind. Roll on the **Mental Corruption Table** found on page 189.
...
The creature can see very well in natural darkness. They can see clearly in such darkness for 20 yards and can extend the effective illumination distance of any light sources by a further 20 yards.

### **Painless**

The creature is impervious to pain. All non-amputation penalties suffered from Critical Wounds are ignored, although Conditions are suffered as normal.

### **Petrifying Gaze**

The creature's gaze can turn flesh to stone. As an Action, the creature may lose its Momentum to unleash its petrifying gaze against one living target it can see. The creature makes a Ballistic Skill Test, opposed by the target's Initiative. If the creature wins, it inflicts a *Stunned* Condition, and one more for each SL after the first. If they win by 6+ SL, the target is permanently turned to stone. If the target is a spellcaster, they can oppose the Test with *Language (Magick)* instead of *Initiative*.

### **Regeneration**

The creature can heal at an extraordinary rate, even regrowing severed parts. At the start of each Round, if they have more than 0 Wounds remaining, they automatically regenerate 1d10 Wounds. If they have 0 Wounds remaining, they regenerate a single Wound on a 1d10 roll of 8+. If they ever roll a 10 for regenerating, they also fully regenerate a Critical Wound, losing all penalties and Conditions associated with it. Any Wounds or Critical Wounds caused by fire may not be regenerated.

### **Size (Various)**

This Trait represents creatures whose size differs from the game standard (i.e. roughly human-sized). There are five steps of Size, ranging from Tiny to Monstrous.

| Size      | Examples                             |
|-----------|--------------------------------------|
| Tiny      | Butterfly, Mouse, Pigeon, Cat, Hawk, |
|           | Human Infant                         |
| Average   | Giant Rat, Halfling, Human Child,    |
|           | Dwarf, Elf, Human                    |
| Large     | Horse, Ogre, Troll                   |
| Enormous  | Griffon, Wyvern, Manticore           |
| Monstrous | Dragon, Giant, Greater Daemon        |
...
When fighting a creature of larger size, you suffer a penalty of -2 SL when using *Melee* to defend in an Opposed Test. It is better to dodge a giant swinging a tree trunk than try to parry it!

#### **Fear**

Agressive creatures cause *Fear* in those smaller than them.

#### **Moving in Combat**

Creatures ignore the need to *Disengage* from melee combat with smaller combatants.

#### **Opposed Strength**

During Opposed Strength Tests (and similar), if one creature is 2 or more *Size* steps larger, they win automatically. If one creature is 1 *Size* step larger, the smaller creature must score a Critical to contest the roll. If they do, SL are compared as normal. All other results mean the larger creature wins.

#### **Outnumbering Larger Creatures**
...
The creature is especially stealthy. They are granted the Stealth (Rural) Skill at Ag +10. This number may be increased at the GM's discretion.

### **Striding Gait (Terrain)**

The creature is at home in the listed terrain. They suffer no penalties for moving through the listed terrain and add +1 SL to Athletics and Stealth Tests in the listed terrain.

# **ADJUSTING A CREATURE'S SIZE**

If you wish to use Size to make a creature bigger then increase *Strength* and *Toughness* by +10 and reduce *Agility* by -5 per step of size you increase the creature. Reverse this if you wish to make a creature smaller.
...
Swarms are large numbers of the same creature acting as one. The swarm counts as a single creature that ignores the Psychology rules (see page 183), and can ignore the Engaged rules when using its Move. All opponents Engaged with a Swarm automatically lose 1 Wound at the end of every Round as the Swarm overwhelms anything close. The Swarm has five times the Wounds of a normal example of the creature and gains +10 Weapon Skill. Any attempts to shoot the Swarm gain a +40 bonus to hit. Swarms ignore all the *Size*  Creature Trait rules.

# **Tail**

The creature's tail is capable of sweeping foes from their feet. They may lose Momentum to make a Free Attack that does SB +2 Damage. Smaller-*Size* targets that suffer any Wounds from the attack also gain the *Prone* Condition.

### **# Tentacles**

The creature has a number of tentacles equal to #. They gain one Free Attack per tentacle. Each tentacle's attack does Damage of SB +0. If they cause Damage, they can also give their opponent an *Entangled* Condition, which will initiate a Grapple between the target and that tentacle. If a tentacle is Grappling, use the tentacle's Free Attack to resolve that Grapple, not the creature's Action (see page 167).

### **Territorial**

This creature is protective of a particular area or location. They will fight to the death to protect it and will not normally pursue enemies if they flee this area.

# **Terror (Rating)**

The creature supernaturally causes bone-chilling *Terror*. When first encountering the creature, opponents must make a Psychology Test (page 183). On a failure, opponents gain *Broken* Conditions equal to the *Terror* Rating, plus 1 for each negative SL. Regardless of the result, it also causes *Fear* (page 183) with an equal *Fear* Rating.
...
This Trait represents animals that have been trained through the *Animal Training* Skill. The skills the animal knows are marked in the parentheses. Feel free to create your own *Trained* skills.
...
**Fetch:** The animal is trained to fetch. This is normally reserved for dogs and similar.
...
The undead are neither living nor dead, meaning they are not reliant on the usual prerequisites for life such as air, food, water, and so on. This Trait most commonly comes into use when spells, Miracles, or other abilities affect *Undead* only.
...
The creature's attacks are poisoned or envenomed. When they cause Wounds, their opponent gains a *Poisoned* Condition. Some poisons are more potent than others, and the listed Difficulty should apply to Tests made to recover from the *Poisoned* Condition. See page 186.

### **Vomit**

Under duress, the creature can spew a stream of corrosive spew, dowsing their opponents in foul, semi-digested filth. If the creature starts their Turn engaged in combat, they can give up their Move and Action to activate their *Vomit*. The attacker performs an Opposed Ballistic Skill/Dodge Test against all targets within 2 yards (the attacker's single roll opposed by each individual target). The Test is Easy (+4 SL) for the vomiting creature, due to the close range, and Challenging (+0 SL) for opponents. All losing targets suffer a hit with TB +4 Damage and receive a *Stunned* condition. All weapons and armour carried by affected targets suffer 1 Damage as stomach acid corrodes them away. A creature may only *Vomit* once every 12 hours.

# **Ward (Rating)**

Perhaps because they are magical, wear a special talisman, or are just plain lucky, some blows just seem to miss. Roll 1d10 after any blow is received: if the roll is Rating or higher, the blow is ignored, even if it is a Critical.

### **Wallcrawler**

The creature can effortlessly scale vertical surfaces and even traverse ceilings, ready to drop on unwary prey. They move at full Movement across any appropriate surface and automatically pass all Climb Tests.

# **Web (Rating)**

The creature can create webbing to trap unwary foes. Whenever they successfully hit, opponents gain 1 *Entangled* Condition, with a Strength of the Rating given. See page 186.
