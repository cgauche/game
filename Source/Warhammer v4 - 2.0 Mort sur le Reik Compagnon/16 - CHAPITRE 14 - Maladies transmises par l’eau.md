...
Bien entendu, boire cette eau n'est pas toujours une action volontaire : un Personnage qui échoue à un Test de Natation avale accidentellement de l'eau en cas d'échec à un Test de **Force Mentale Intermédiaire (+0)**.

À la discrétion du MJ, les Personnages ayant des blessures ouvertes peuvent également risquer d'être exposés s'ils tombent ou sautent dans une rivière.

### **EXPOSITION**

Chaque fois qu'un Personnage risque d'être exposé à une maladie provenant de l'eau d'une rivière, il est possible qu'il doive réaliser un Test de **Résistance Intermédiaire (+0)**, modifié selon les circonstances. Consultez les tableaux suivants : tous les modificateurs peuvent être cumulés.

#### QU'EST-CE QU'ON S'AMUSE !

Les maladies présentées dans ce chapitre vont du dégoûtant à l'agaçant, en passant par le débilitant. Elles servent à rappeler aux Personnages les difficultés quotidiennes, voire les horreurs, de la vie au sein du monde sinistre et périlleux de Warhammer Fantasy. Après tout, la seule chose pire que d'affronter des hommes-bêtes est d'être confronté à un cas sévère de Vers du Reik.

Il faut toutefois faire attention à ne pas appliquer ces règles trop souvent. Un Personnage insouciant qui barbote constamment dans les eaux troubles du Reik devrait certainement faire l'objet de quelques Tests de Résistance pour voir s'il a ramené des visiteurs indésirables. À l'inverse, faire effectuer aux Personnages un Test de dépistage de diverses maladies chaque fois qu'ils prennent un verre avec leur repas dans une auberge bien entretenue (selon les critères de l'Empire) va un peu trop loin. Si l'ensemble du groupe est constamment affaibli par un assortiment de maladies, le jeu s'en trouvera rapidement perturbé.

Cependant, ce chapitre et les différents remèdes à base de plantes d'Hortensia Flaquepeton, présentés au Chapitre 2, vous donnent une certaine marge de manœuvre. Si le groupe comprend un herboriste ou un autre guérisseur capable de traiter les affections des Personnages, ces maladies risquent de moins perturber votre jeu et le Personnage herboriste n'en sera que plus apprécié.

#### TABLEAU D'EXPOSITION 1 : SOURCE D'EAU

Les modificateurs suivants s'appliquent à l'ingestion et à l'immersion.

| Emplacement                                                        | Modificateur |
|--------------------------------------------------------------------|--------------|
| Grande ville ; marais                                              | –30          |
| Dans un rayon de 8 km en aval d'une grande<br>ville ou d'une ville | –20          |
| Dans un rayon de 3 km en aval d'une ville                          | –10          |
| Campagne                                                           | 0            |
| En amont de toute habitation                                       | +10          |

## TABLEAU D'EXPOSITION 2 : BLESSURES ET ÉTATS

Les modificateurs suivants s'appliquent uniquement à l'immersion.
...
Si le Test de Résistance est raté, lancez un dé selon le tableau suivant, avec un modificateur de +10 pour chaque DR négatif.

#### TABLEAU DES MALADIES TRANSMISSIBLES PAR L'EAU

| 01–40<br>Courante galopante<br>41–60<br>Colique<br>61–70<br>Infection mineure1<br>71–75<br>Blessure Purulente1<br>76–80<br>Vers de carie<br>81–90<br>Vers du Reik | 1d100 | Maladie       |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|---------------|
|                                                                                                                                                                   |       |               |
|                                                                                                                                                                   |       |               |
|                                                                                                                                                                   |       |               |
...
**Contraction :** exposition à de l'eau sale ou à des aliments avariés ; effectuez les Tests de la page précédente.
...
**Contraction :** exposition à de l'eau sale ; effectuez les Tests

comme indiqué page 91. **Incubation :** 2 heures. **Durée :** 2d10 jours.

**Symptômes :** Crampes abdominales, Fièvre, Intoxication

alimentaire (Modérée), Nausée.
...
comme indiqué page 91. **Incubation :** 85 + 1d10 jours.

**Durée :** 1 semaine.

**Symptômes :** spéciaux (voir ci-contre).

#### **Effets des vers du Reik**

Pour chaque période complète de 30 jours d'infection, le Personnage subit une pénalité de –5 à tous les Tests de **Résistance** permettant de résister aux maladies. Cette pénalité est réduite de 1 point par jour après la mort du ver.

Pour déterminer où le ver fait surface, effectuez un lancer de Localisation comme lors d'un combat normal. Lorsque l'ampoule se forme, le patient subit une pénalité de –5 % à tous les Tests d'Agilité en raison de l'irritation constante. De plus, si l'ampoule se trouve à un endroit visible, le Personnage subit également une pénalité de –10 aux Tests de Sociabilité.

Le septième jour suivant l'apparition de la cloque, la personne atteinte doit effectuer un Test de Résistance toutes les heures. Au premier échec, ou à la dernière heure du jour si tous les Tests sont réussis, la cloque éclate, infligeant 1 Blessure et provoquant un État *Sonné* en raison de la sensation de brûlure presque insupportable qui en résulte. Ce phénomène persiste jusqu'à ce que la plaie reçoive des soins médicaux, mais il peut être temporairement atténué si l'ampoule est immergée dans l'eau.

Il n'existe pas de traitement connu contre les vers du Reik, si ce n'est de laisser le cycle suivre son cours. Certains médecins ont essayé de le retirer du patient une fois que la cloque s'est formée et que l'emplacement où se cachait ce parasite est devenu visible, mais cette approche fait généralement plus de mal que de bien, et le patient met plus de temps à s'en remettre.

### **NOUVEAUX SYMPTÔMES**

### **Crampes abdominales**

De violentes crampes abdominales saisissent le patient par intermittence, l'obligeant à se tordre de douleur.

Ce dernier subit une pénalité de –20 à tous les Tests en raison de la perturbation provoquée par ces crampes douloureuses.

Lorsqu'un Test se solde par un échec normal ou pire, il se plie en deux de douleur, incapable de bouger ou d'agir pendant le prochain Round, et gagne l'État *Sonné*.

Sur un Échec Impressionnant ou pire, il doit effectuer un Test de **Force Mentale** ou tomber au sol, gagnant l'État *À Terre*.
