...
**Coût :** 150 CO (Bronze) ; 200 CO (Fer) pour 10 mètres de longueur.

**Poids (pour 10 mètres de longueur) :** +100 Points d'Encombrement (Fer) ; +115 Points d'Encombrement (Bronze).
...
**Bronze :** 1 PA ; doit être gratté au moins une fois tous les trois mois pour éviter que l'oxydation ne fasse apparaître des irrégularités à la surface de la coque et qu'elle ne se recouvre d'algues, ce qui augmenterait la traînée et réduirait la maniabilité du bateau (-1 M, -10 aux Tests de **Navigation**). La valeur d'armure du blindage ne serait cependant pas affectée.

**Fer :** 2 PA ; doit être gratté au moins une fois par mois pour éviter l'apparition de taches de rouille, ce qui augmenterait la traînée et réduirait la maniabilité du bateau (-1 M, -10 aux Tests de **Navigation**). Si ce processus d'entretien n'est pas respecté, alors le blindage rouille et perd toute sa valeur d'armure.

### **Coque de course**

**Coût :** 220 CO pour 10 mètres de longueur.

**Poids :** -50 Points d'Encombrement pour 10 mètres de longueur.
...
#### LE BATEAU LE PLUS RAPIDE DU REIK

Ces règles permettent aux Personnages de personnaliser leur bateau afin d'augmenter sa vitesse ainsi que ses capacités défensives et offensives. Vous remarquerez que les coûts de ces modifications sont assez élevés, ceci en raison du fait que les artisans qualifiés ne travaillent pas gratuitement, mais aussi parce que des Personnages qui passent beaucoup de temps à commercer sur le Reik peuvent se retrouver en possession d'un excédent d'or qu'il est nécessaire de leur faire dépenser.

Ces améliorations seront d'autant plus utiles si vous donnez à vos Personnages l'opportunité d'en tirer un réel avantage. Utiliser les idées de rencontres sur la rivière décrites dans ce livre pour mettre à l'épreuve vos Personnages et leur supposée maîtrise des voies fluviales de l'Empire. S'ils venaient à être vaincus et volés par des pirates, ils auraient tout intérêt à équiper leur bateau de quelques armes et d'un blindage pour parer aux attaques futures. S'ils font ce choix, assurez-vous que les mêmes pirates les abordent à nouveau, s'imaginant prétentieusement s'en prendre à une « proie facile » déjà connue, pour finalement se retrouver face à une coque blindée et des armes à feu cachées.
...
Toute réparation effectuée sur une coque lissée coûte 50 % plus cher que pour une coque normale (voir p. 30) ; opter pour des réparations moins coûteuses, c'est perdre les avantages conférés par le lissage.

## **SYSTÈME DE DIRECTION**

### **Safran**

**Coût :** 5 CO (barque) ; 25 CO (esquif de pêche) ; 50 CO (barge moyenne ou bateau de patrouille) ; 120 CO (grande barge).

**Poids :** +5 Points d'Encombrement (barque) ; +20 Points d'Encombrement (esquif de pêche) ; +40 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +80 Points d'Encombrement (grande barge).
...
**Coût :** 8 CO (barque) ; 30 CO (esquif de pêche) ; 60 CO (barge moyenne ou bateau de patrouille) ; 120 CO (grande barge).

**Poids :** +5 Points d'Encombrement (barque) ; +35 Points d'Encombrement (esquif de pêche) ; +55 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +95 Points d'Encombrement (grande barge).
...
**Coût :** 10 CO (barque) ; 45 CO (esquif de pêche) ; 75 CO (barge moyenne ou bateau de patrouille) ; 140 CO (grande barge).

**Poids :** +15 Points d'Encombrement (barque) ; +40 Points d'Encombrement (esquif de pêche) ; +50 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +110 Points d'Encombrement (grande barge).
...
**Coût :** 15 CO (barque) ; 60 CO (esquif de pêche) ; 120 CO (barge moyenne ou bateau de patrouille) ; 300 CO (grande barge).
...
**Coût :** 5 CO (barque) ; 15 CO (esquif de pêche) ; 30 CO (barge moyenne ou bateau de patrouille) ; 45 CO (grande barge).

**Poids :** +5 Points d'Encombrement (barque) ; +20 Points d'Encombrement (esquif de pêche) ; +35 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +60 Points d'Encombrement (grande barge).

La coque est surélevée au-dessus du pont, environ à hauteur de taille pour un personnage humain. En plus d'empêcher les vagues hautes de noyer le pont du bateau, le plat-bord offre une couverture moyenne à un Personnage ou PNJ s'accroupissant sur le pont (**WFJDR**, p. 161) et les tirs de projectiles contre lui sont rendus Difficiles.

#### **Allégement**

**Coût :** 20 CO (barque) ; 50 CO (esquif de pêche) ; 150 CO (barge moyenne ou bateau de patrouille) ; 250 CO (grande barge).

**Poids :** -10 Points d'Encombrement (barque) ; -15 Points d'Encombrement (esquif de pêche) ; -45 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; -80 Points d'Encombrement (grande barge).
...
**Coût :** 5 CO (barque) ; 20 CO (esquif de pêche) ; 40 CO (barge moyenne ou bateau de patrouille) ; 80 CO (grande barge).

**Poids :** +5 Points d'Encombrement (barque) ; +25 Points d'Encombrement (esquif de pêche) ; +45 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +70 Points d'Encombrement (grande barge).

Un clinfoc est une voile supplémentaire située à la proue et qui nécessite un beaupré pour être ajoutée au bateau, augmentant sa longueur de 10 %. Gonflé par un vent arrière, le clinfoc accorde au bateau un bonus de vitesse de Mouvement de +5 % par rapport à la valeur indiquée dans le Tableau des vents (p. 28). Il est inutile en cas de vent de côté, et double le malus à la vitesse de Mouvement en cas de vent contraire.

### **Gréement de course**

**Coût :** 8 CO (barque) ; 30 CO (esquif de pêche) ; 60 CO (barge moyenne ou bateau de patrouille) ; 120 CO (grande barge).

**Poids :** +5 Points d'Encombrement (barque) ; +15 Points d'Encombrement (esquif de pêche) ; +25 Points d'Encombrement (barge moyenne ou bateau de patrouille) ; +50 Points d'Encombrement (grande barge).
...
### **Dames de nage fermées**

**Coût :** 5 CO la pièce.

**Poids :** +5 Points d'Encombrement par pièce.
...
**Poids :** 0 Point d'Encombrement par pièce.
...
Certains pirates, et autres équipages souhaitant paraître inoffensifs dissimulent les armes montées de leur bateau derrière des sabords et à l'intérieur de fausses caisses, ne les dévoilant que lorsqu'ils sont prêts à passer à l'action. Toutes les armes figurant dans cette section peuvent être cachées, mais leur prix et leurs points d'encombrement augmentent alors de 10 %.

Quelques honnêtes gens utilisent aussi cette technique, car bien qu'une arme à feu mise en évidence peut suffire à effaroucher de potentiels agresseurs, elle peut aussi attirer l'attention des patrouilleurs fluviaux.
...
Les canons peuvent être chargés avec trois types de munitions différents :

Le **boulet** est un boulet de canon standard, qui pulvérise sa cible avec une efficacité redoutable. Un canon chargé avec un boulet gagne l'Atout d'arme Percutante. C'est la munition idéale pour endommager ou couler un autre bateau, ou détruire un bâtiment.
...
Et comme les catapultes moyennes, les mortiers requièrent 3 actions pour être déplacés ; il est donc assez compliqué de viser précisément quand on tire au mortier.

### **Fourquines**

**Coût :** 1 CO la pièce.

**Poids :** +1 point d'Encombrement par pièce.
...
**Coût :** 15 CO (esquif de pêche) ; 30 CO (barge moyenne) ; 60 CO (grande barge).

**Poids :** +30 Points d'Encombrement (esquif de pêche) ; +60 Points d'Encombrement (barge moyenne) ; +120 Points d'Encombrement (grande barge).
...
Un fusil à salve est assez semblable à un pistolet à répétition, mais contrairement à ce dernier, tous ses canons tirent en même temps. Il comporte généralement sept canons : un au milieu, et six autres disposés tout autour, formant un hexagone. Bien que mortel pour ceux qui se trouvent du mauvais côté de ses canons, le fusil à salve n'est pas sans danger pour l'utilisateur inexpérimenté. Chaque fois qu'il tire, l'utilisateur doit faire un Test de **Résistance Accessible (+20)**, et le violent recul de l'arme contre son épaule lui inflige 1 Blessure pour chaque DR négatif. S'il fait un Échec Stupéfiant, il se voit infliger un Coup Critique à l'épaule : utilisez le tableau des Blessures critiques au bras (**WFJDR**, p. 175-176), en ajustant au besoin quelques détails, pour illustrer la blessure subie à l'épaule.

### ARMES MONTÉES SUR BATEAU

| Arme                | Prix   | Enc. | Disponibilité | Portée | Dégâts | Atouts et Défauts*                                               |
|---------------------|--------|------|---------------|--------|--------|------------------------------------------------------------------|
| Baliste             | 30 CO  | 20   | Limité        | 100    | +12    | Pointue, Empaleuse, Perforante, Recharge 3                       |
| Canon (petit)       | 40 CO  | 30   | Limité        | 50     | +10    | Explosion 2, Dévastatrice, Dangereuse,<br>Recharge 4             |
| Canon (moyen)       | 100 CO | 50   | Exotique      | 75     | +14    | Explosion 3, Dévastatrice, Dangereuse,<br>Recharge 6             |
| Catapulte (petite)  | 20 CO  | 25   | Limité        | 50     | +10    | Dévastatrice, Percutante, Imprécise, Recharge 3                  |
| Catapulte (moyenne) | 40 CO  | 40   | Limité        | 75     | +15    | Dévastatrice, Percutante, Imprécise, Recharge 3                  |
| Fusil à salves      | 10 CO  | 5    | Exotique      | 50     | +9     | Explosion 2, Dangereuse, Recharge 7                              |
| Mortier             | 50 CO  | 50   | Exotique      | 30     | +20    | Explosion 5, Dévastatrice, Percutante,<br>Dangereuse, Recharge 4 |
| Pierrier            | 20 CO  | 5    | Rare          | 30     | +15    | Explosion 2, Dangereuse, Recharge 4                              |
...
Un bateau propulsé par un moteur à vapeur conserve sa vitesse de Mouvement standard tant qu'il est approvisionné en carburant, sans tenir compte de la direction du vent. Il nécessite d'être manœuvré par un ingénieur qualifié, qui réalisera des Tests de **Métier (Ingénieur)** plutôt que les habituels Tests de **Navigation**. Malgré tout, les moteurs à vapeur ne sont pas toujours fiables, et en dépit de leur taille et de leur grosse machinerie, leurs mécanismes sont assez fragiles. En cas d'échec au Test de **Métier (Ingénieur)**, si un double est obtenu au jet de dé ou si l'échec est Stupéfiant, ou en cas de Coup Critique à la coque du bateau, lancez 1d100 selon le tableau suivant :

|       | DÉFAILLANCE DE MOTEUR À VAPEUR                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |  |  |  |  |  |  |
|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--|--|--|--|--|--|
| D100  | Résultat                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |  |  |  |  |  |  |
| 01–40 | Le moteur broute : le moteur tousse un peu et perd de la vapeur. Pour les 1d10 prochains Rounds, le bateau dérive au gré du<br>courant à 25 % de sa vitesse de Mouvement normale.                                                                                                                                                                                                                                                                                                                                                                                                                        |  |  |  |  |  |  |
| 41–60 | Fuite de vapeur : Un jet de vapeur jaillit de la chaudière. La personne assignée au moteur doit réussir un Test d'Initiative ou être<br>ébouillantée pour 1d10 –5 Points de Blessure (minimum de 1), ignorant l'armure.                                                                                                                                                                                                                                                                                                                                                                                  |  |  |  |  |  |  |
| 61–80 | Perte de pression : le moteur cesse de fonctionner. Le bateau dérive au gré du courant à 25 % de sa vitesse de Mouvement<br>normale jusqu'à la réussite d'un Test de Métier (Ingénieur) Intermédiaire (+0) pour remettre le moteur en marche. Après le<br>redémarrage du moteur, il faut attendre 5 –DR Rounds avant que le niveau de pression de la vapeur remonte suffisamment<br>pour permettre la propulsion du bateau.                                                                                                                                                                              |  |  |  |  |  |  |
