...
Bien que la plupart des démons vouent allégeance à l'un des quatre dieux du Chaos, certains sont de simples créatures de l'Aethyr, ne possédant aucune volonté propre, se déversant sur le Vieux Monde dans une frénésie destructrice aveugle chaque fois qu'ils le peuvent. Seuls quatre exemples de démons sont décrits ici – deux démons Inférieurs et deux Princes démons –, d'autres ouvrages leur consacrant beaucoup plus d'importance.
...
**Traits :** Arme +9, Arme (griffes), Armure 5, Champion, Cornes +8, Corruption (Modérée), Démoniaque 8+, Frénésie, Insensible à la douleur, Instable, Peur 3
...
# **Slenderthigh Whiptongue – Prince démon de Slaanesh**

| M | CC | CT  | F   | E   | I   | Ag | Dex | Int | FM | Soc | B  |
|---|----|-----|-----|-----|-----|----|-----|-----|----|-----|----|
| 6 | 95 | 110 | 115 | 120 | 100 | 95 | 40  | 70  | 85 | 85  | 86 |

**Traits :** Arme +16, Armure 1, Champion, Cornes +15, Corruption (Majeure), Démoniaque 8+, Instable, Lanceur de Sorts (Slaanesh), Perturbant, Taille (Grande), Terreur 3, Vision nocturne

# **Fr'hough Mournbreath – Prince démon de Nurgle**

| M | CC | CT | F   | E   | I  | Ag | Dex | Int | FM  | Soc | B   |
|---|----|----|-----|-----|----|----|-----|-----|-----|-----|-----|
| 4 | 70 | 35 | 120 | 150 | 50 | 20 | 30  | 85  | 120 | 50  | 108 |

**Traits :** Arme +15, Armure 4, Cornes +14, Corruption (Majeure), Démoniaque 7+, Infecté, Infravision, Instable, Lanceur de Sorts (Nurgle), Maladie (Vérole urticante), Parasité, Souffle +12 (Corrosif ), Taille (Grande), Terreur 3

# **Les ignobles hommes-rats**

Les skavens constituent une race malveillante d'hommes-rats vivant sous les pieds de tous, surveillant avec impatience. Ils survivent dans les égouts et les tunnels sous les cités de l'Empire et sont si rarement aperçus qu'ils sont souvent considérés à tort comme des hommes-bêtes ou des mutants. Peu de gens soupçonnent la sinistre vérité : un Empire souterrain se développe juste sous leurs pieds, ses tunnels s'étendant entre chaque cité du Vieux Monde et au-delà.

La société skaven est établie sur le dos d'esclaves capturés à travers le Vieux Monde. Beaucoup d'humains véreux les soutiennent en fournissant des esclaves et des malepierres en échange de faveurs immondes et de connaissances secrètes : le réseau d'espions skavens est vaste et omniprésent.

Conscients de la position délicate qu'ils occupent, se régalant dans les entrailles souterraines des autres sociétés, les skavens protègent leurs secrets par tous les moyens. Ceux qui sont assez fous pour parler ouvertement d'une civilisation complexe d'hommes-rats doués de conscience sous les rues pavées de l'Empire peuvent bien finir agonisant dans un caniveau, victimes malheureuses d'accidents improbables.

*« J'en ai pas vu. Y avait pas d'hommes-rats, vous entendez ? Juste de la malchance. Wilbur a glissé et il est tombé, c'est tout. Il était imprudent, est tombé d'une échelle sur son propre couteau. Dix fois. Juste de la malchance. »*
...
**Traits :** , Arme +7, Armure 2, Infecté, Vision nocturne

**Facultatif :** Furtif, Maladie (Fièvre du rongeur), Mutation, Nerveux, Pisteur
...
**Traits :** Arme +9, Armure 1, Infecté, Stupide, Taille (Grande), Vision nocturne **Facultatif :** Attaque caudale +8, Corruption (Mineure), Dressé (Dompté, Garde, Guerre, Monture), Infravision, Maladie (Fièvre du rongeur), Mutation, Parasité, Pisteur
