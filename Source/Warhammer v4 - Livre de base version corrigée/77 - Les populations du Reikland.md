...
Pour les personnages importants de votre campagne, vous pouvez utiliser les règles complètes de création de Personnages. Cependant, vous avez parfois juste besoin rapidement d'un PNJ. Pour cela, utilisez l'un des profils standard suivants et ajoutez les Traits de créature selon les besoins. Les traits listés dans les Traits standard de créature sont les meilleurs choix de départ.
...
**Facultatif :** À distance +8 (50), Lanceur de Sorts, Maladie
...
**Traits :** Animosité (une catégorie au choix), Arme +7, Haine (peaux-vertes), Préjugé

(un au choix), Résistance à la Magie, Vision nocturne

**Facultatif :** À distance +8 (50), Rage
...
**Traits :** Arme +5, Taille (Petite), Vision nocturne

**Facultatif :** À distance +7 (25), Furtif

# **Elfe (haut et sylvain)**

| M | CC | CT | F  | E  | I  | Ag | Dex | Int | FM | Soc | B  |
|---|----|----|----|----|----|----|-----|-----|----|-----|----|
| 5 | 40 | 40 | 30 | 30 | 50 | 40 | 40  | 40  | 40 | 30  | 13 |

**Traits :** Animosité (une catégorie au choix), Arme +7, Préjugé (un au choix), Vision

nocturne **Facultatif :** À distance +9 (150), Arboricole, Furtif, Lanceur de Sorts (un au choix),
...
Originaires des terres situées très à l'est, les ogres sont répandus dans le Vieux Monde car ils adorent errer, toujours à la recherche de nouvelles proies. Au cours de leurs voyages à but alimentaire, longs de plusieurs décennies, ils mettent tout en œuvre pour s'intégrer, portant des vêtements de la région et suivant les coutumes locales qu'ils comprennent, car cela leur permet d'attirer plus facilement leur prochaine proie.
...
**Traits :** Affamé, Arme +8, Armure (Peau 1), Préjugé (Maigrichons), Taille

(Grande), Vision nocturne

**Facultatif :** Belliqueux, Infecté, Pisteur
...
Personne ne sait pourquoi, mais les halflings et les ogres s'entendent bien. Beaucoup d'anciens des clans halflings ont un ou deux gardes du corps ogres, et l'on dit que l'Ancien du Moot voyage rarement sans son vieil ami Zorarth Mord-Gigot, un ogre aux cheveux blancs qui vit dans l'Empire depuis près d'un siècle. En retour, de nombreuses bandes de mercenaires ogres emploient des halflings comme cuisiniers.
...
**Traits :** À distance +8 (50), Animosité (les riches et les hommes-bêtes), Arboricole, Arme +8, Armure (Légère 2), Brutal, Endurant, Préjugé (Baillis, Juristes)

# **Pol Dankels — Sorcier humain**
