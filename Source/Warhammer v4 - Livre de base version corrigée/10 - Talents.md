...
Voici comment les Talents sont présentés :

- **Nom du Talent (utilisation) :** la dénomination du Talent. S'il y a des parenthèses, le mot à l'intérieur décrit une utilisation que le Talent influence.
- **Maxi :** cela indique le nombre maximum d'acquisitions de ce Talent, en général 1 ou un Bonus de Caractéristique associée.
- **Tests :** si le Talent est lié à un ou plusieurs Tests que votre Personnage peut effectuer, les Tests concernés sont listés ici. Les Talents liés à un Test possèdent une règle supplémentaire : pour chaque acquisition de ce Talent, vous gagnez +1 DR pour toute utilisation réussie de la Compétence liée au Talent.
- **Description (sans titre en gras) :** une description de l'usage d'un Talent.

# **Liste complète des Talents**
...
**Maxi :** Bonus de Sociabilité **Tests :** Charme pour Baratiner
...
**Tests :** Tests de Métier pour réparer des objets cassés Vous êtes une sorte de touche-à-tout, capable de réparer presque n'importe quoi. Vous considérez toutes les Compétences Métier non magiques comme étant de Base lorsque vous

réparez des objets cassés.
...
**Maxi :** Bonus d'Intelligence **Tests :** Savoir (Apothicaire)
...
**Tests :** Tests de Corps à corps quand vous êtes en *Frénésie* Vous êtes davantage en mesure de contrôler votre *Frénésie* en combat. Vous pouvez y mettre fin avec un Test de Calme réussi à la fin du Round.
...
Vous avez été formé à combattre côte à côte avec d'autres soldats. Si un ennemi vous fait perdre des Avantages alors qu'il se tient à côté d'un allié actif possédant le Talent Coude-àcoude, vous pouvez conserver 1 Avantage perdu pour chaque fois que vous avez pris le Talent Coude-à-coude.
...
Vous êtes un criminel actif qui gagne de l'argent grâce à des sources illégales, et vous n'êtes pas toujours discret à ce sujet. Pour calculer vos revenus, que ce soit quand vous Gagnez de l'argent ou quand vous effectuez une Activité *Revenus*, référezvous au tableau suivant :

| Standing de Carrière | Bonus d'argent par fois où le Talent est pris |
|----------------------|-----------------------------------------------|
| 1                    | +2d10 sous de cuivre                          |
| 2                    | +1d10 pistoles d'argent                       |
| 3                    | +2d10 pistoles d'argent                       |
| 4                    | +1 couronne d'or                              |
...
**Tests :** Langue (Magick) quand vous faites une Incantation Vous comprenez instinctivement la langue Magick et êtes capable d'articuler rapidement les phrases les plus complexes sans erreur. Vous ne subissez pas d'Incantation Imparfaite si vous obtenez un double à un Test réussi de Langue (Magick).
...
| Talent pris | Nombre de soldats influencés                            |
|-------------|---------------------------------------------------------|
| 1           | Normal x 5                                              |
| 2           | Normal x 10                                             |
| 3           | Normal x 20                                             |
...
| 7           | Normal x 500                                            |
| 8           | Normal x 1000                                           |
| 9           | Tous ceux qui peuvent entendre votre voix<br>inspirante |
...
**Maxi :** Bonus de Sociabilité **Tests :** Charme (Mendicité)
...
**Tests :** Charme quand vous parlez pour défendre votre cause Quand vous parlez pour défendre votre cause, votre situation ou votre religion, vos mots vibrent de passion et d'ardente ferveur. Vous pouvez doubler votre Sociabilité pour calculer le nombre de personnes que vous influencez avec votre Talent Orateur (voir page 142) quand vous défendez votre cause.

# **Flagellant**

**Maxi :** Bonus d'Endurance

**Tests :** Tout Test pour résister aux Puissances de la Ruine Vous avez voué votre douleur au service de votre Dieu. Chaque jour, vous devez passer une demi-cloche (une demi-heure) à prier en continuant à vous infliger un nombre de Blessures égal à votre Niveau de Flagellant. Jusqu'à votre prochain repos, si vous possédez le Talent Frénésie, vous pouvez entrer en *Frénésie* immédiatement sans effectuer de Test.
...
**Maxi :** Bonus de Force **Tests :** Escalade
...
**Maxi :** Bonus de Force **Tests :** Ramer et Natation
...
**Remarque :** le Talent Linguistique fonctionne uniquement pour les langues utilisées pour communiquer avec les autres, il ne fonctionne donc pas avec Langue (Magick).
...
| Bonus d'Intelligence x 1 | 100 PX |
|--------------------------|--------|
| Bonus d'Intelligence x 2 | 200 PX |
| Bonus d'Intelligence x 3 | 300 PX |
| Bonus d'Intelligence x 4 | 400 PX |

Donc, si votre Bonus d'Intelligence est de 4, les 4 premiers Sorts vous coûteront 100 PX chacun, puis 200 PX pour les 4 suivants, et ainsi de suite. Les règles complètes sur l'apprentissage de nouveaux Sorts se trouvent dans le Chapitre 8 : Magie. Dans des conditions normales, vous ne pouvez pas apprendre plus d'un Talent Magie des Arcanes (Domaine). De plus, vous ne pouvez pas apprendre les Talents Béni ou

Invocation quand vous possédez le Talent Magie des Arcanes. Vous pouvez désapprendre ce Talent pour 100 PX, mais si vous

le faites, vous perdez immédiatement tous vos Sorts.
...
| Nombre de Sorts<br>connus actuels | Coût en PX pour<br>un nouveau sort supplémentaire |
|-----------------------------------|---------------------------------------------------|
| Jusqu'à Bonus FM x 1              | 50 PX                                             |
| Jusqu'à Bonus FM x 2              | 100 PX                                            |
| Jusqu'à Bonus FM x 3              | 150 PX                                            |
...
**Maxi :** Bonus de Dextérité **Tests :** Métier (au choix)
...
**Maxi :** Bonus de Force **Tests :** Intimidation
...
**Tests :** Charme et Ragot lors des fêtes, Résistance à l'alcool Vous êtes un fêtard chevronné et vous savez comment vous amuser. Vous pouvez inverser le résultat de n'importe quel Test de Résistance à l'alcool raté si cela entraîne un succès.
...
**Tests :** N'importe quel Test pour traquer ou capturer du gibier Vous êtes un chasseur expérimenté et connaissez toutes les meilleures techniques pour trouver du gibier.
...
| 7           | Normal x 500                                       |
| 8           | Normal x 1000                                      |
| 9           | Toutes celles qui peuvent entendre votre voix d'or |
...
**Maxi :** Bonus d'Intelligence **Tests :** Savoir (Savoir choisi)
...
**Tests :** n'importe quel Test pour détecter les Vents de Magie Vous pouvez percevoir les Vents changeants de la Magie, qui soufflent depuis les Portes du Chaos jusqu'aux pôles du monde. Vous possédez à présent Seconde vue (voir page 233).
...
**Maxi :** Bonus d'Initiative **Tests :** Perception (Sens)
