...
Si vous n'êtes pas encore *Engagé* en combat, vous pouvez utiliser votre Mouvement pour Charger. Si vous Chargez, votre action doit être un Test de Corps à corps pour attaquer un adversaire.
...
À votre tour, vous pouvez utiliser votre Action pour courir. Vous avez besoin d'un Test **d'Athlétisme Accessible (+20)**, et la distance couverte vient en plus de celle parcourue par votre Mouvement de ce Round. Vous pouvez courir sur une distance équivalente à votre Mouvement de Course + DR en mètres (voir Tableau des Mouvements pour les Mouvements en Charge). Ainsi, un Personnage avec Mouvement 4 qui obtient DR -2 pourra courir sur 14 mètres supplémentaires (16-2=14).
...
- **2 : Test** Tout participant à la poursuite effectue un Test pour son Mouvement – en fonction des circonstances, ce sera un Test de Conduite d'Attelages, de Chevaucher ou d'Athlétisme.
- **3 : Actualiser la Distance** On compare le DR le plus petit obtenu par les poursuivis au plus haut DR obtenu par les poursuivants, et la différence est ajoutée à la Distance si les poursuivis l'ont emporté et retranchée de cette même Distance si ce sont les poursuivants qui l'ont emporté.
