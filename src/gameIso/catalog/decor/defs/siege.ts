...
const front = (cx: number) =>
  `<g><rect x="${cx - 24}" y="74" width="48" height="58" rx="15" fill="#7a2222"/>` +
  `<rect x="${cx - 17}" y="80" width="34" height="46" rx="11" fill="#9c3636"/>` +
  `<rect x="${cx - 17}" y="80" width="34" height="12" rx="5" fill="#c9a14a"/>` +
  `<path d="M${cx - 24} 119 Q${cx} 133 ${cx + 24} 119 L${cx + 24} 138 Q${cx} 150 ${cx - 24} 138 Z" fill="#8e2b2b"/>` +
  `<rect x="${cx - 28}" y="103" width="9" height="44" rx="3" fill="#b58a2e"/>` +
  `<rect x="${cx + 19}" y="103" width="9" height="44" rx="3" fill="#b58a2e"/>` +
  `<circle cx="${cx - 24}" cy="103" r="5.5" fill="#d8b24e"/><circle cx="${cx + 24}" cy="103" r="5.5" fill="#d8b24e"/></g>`;
...
const back = (cx: number) =>
  `<g><rect x="${cx - 24}" y="66" width="48" height="74" rx="17" fill="#641c1c"/>` + // dos sombre
  `<rect x="${cx - 18}" y="71" width="36" height="66" rx="13" fill="#8a2a2a"/>` + // bombé clair
  `<rect x="${cx - 18}" y="71" width="36" height="10" rx="5" fill="#c9a14a"/>` + // rail haut doré
  `<line x1="${cx}" y1="84" x2="${cx}" y2="133" stroke="#531616" stroke-width="2.5" opacity="0.6"/>` + // couture
  `<rect x="${cx - 24}" y="133" width="8" height="14" fill="#3a2c1e"/><rect x="${cx + 16}" y="133" width="8" height="14" fill="#3a2c1e"/></g>`; // pieds entrevus
...
export const prop: PropViz = {
  ...
  render: (_params, ctx) => {
    ...
    const body =
      `<g><ellipse cx="60" cy="147" rx="28" ry="7" fill="#000" opacity="0.22"/>` +
      seat(60) +
      `</g>`;
