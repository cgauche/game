...
// Rangée de fauteuils d'opéra (3×1) : velours rouge + dorures, accoudoirs et clous dorés,
// quatre sièges alignés — remplit le parterre. Doit se lire « fauteuils de théâtre » au 1er coup d'œil.
export const prop: PropViz = {
  id: 'rangee-sieges',
  foot: { w: 3, h: 1 },
  label: 'Rangée de fauteuils',
  render: () =>
    `<g><ellipse cx="60" cy="147" rx="55" ry="9" fill="#000" opacity="0.22"/>` +
