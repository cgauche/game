/**
 * CHARIOT LOURD (`chariot-lourd`, `vehicles.json` — EDOC compagnon p.27) — variante de TAILLE du
...
export const landArt: LandArtDef = { id: 'chariot-lourd', front: chariotFront, profile: chariotProfile, back: chariotBack };
