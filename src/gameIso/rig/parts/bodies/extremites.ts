...
// Extrémités de CHAIR/SYSTÈME (pied, main, cou) — Nu d'espèce servant de repli aux zones que
// resolve.ts résout par table de priorité (override → armure → tenue → repli), au même titre que
// tete/torse/jambes. Une tenue/armure PEUT désormais piloter ces zones (parts/*/types.ts).
