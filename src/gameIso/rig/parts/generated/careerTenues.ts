...
const MANUAL: Record<string, TenueSlots> = {
  ...
  // Guerrier du Chaos : ARMURE DE PLATES INTÉGRALE dédiée (cuirasse bombée à étoile du Chaos,
  // épaulières à POINTES, heaume intégral CORNU à fente en T) — remplace l'ex-bricolage
  // « tenue Soldat recolorée + plastron plaqué en overlay » (retour utilisateur : le Vampire a
  // sa tenue, le Guerrier du Chaos la mérite aussi). @metal = plates sombres, @vet2 = garnitures
  ...
  'Guerrier du Chaos': {
    ...
    tete: {
      ...
      back: `<g stroke-linejoin="round">`
        ...
        + `</g>`,
      profile: `<g stroke-linejoin="round">`
        // corne = élément LATÉRAL PAIR → lateralPair() (lointaine en parallaxe + proche)
