...
export const creature: CreatureDef = {
  ...
  quad: {
    ...
    deco: {
      ...
      // (×tailLen puis rotate(-42) = axes monde) pour suivre l'arc vertical de la queue au
      ...
      // Clé #profile : la compensation ne vaut que pour l'os queue du profil (dos = autre repère).
      'queue#profile': `<g data-deco="piquants" transform="scale(1.15) rotate(-42)">` +
