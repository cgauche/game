/**
 * DÉTAIL de surface des PEINTRES SVG D'AUTHORING (frontière du module : `authoring/project.ts` ;
 * matériaux v2 « dessiné main ») — consomme les
 ...
 *  et le WebGL (`backends/webgl/groundAccents.ts`), ces deux
