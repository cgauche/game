  ...
  return (
    <div className="pov-stage" style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
      {/* BRUME DE FOND : elle se pose DERRIÈRE le canevas (`zIndex: -1`) — le monde porte déjà la sienne
          dans le VOLUME (le dégradé de ciel dehors, la nappe d'intérieur dedans), et un fond opaque posé
          par-dessus l'effacerait. Elle ne couvre que le temps de l'entrée en scène, où le canevas reste
          vierge. */}
      ...
      {/* VOILES D'ÉCRAN (#1176, P3-1c) : voile chaud d'extérieur et vignette, les defs d'ambiance
          ...
          ciel et les brumes (`reposerCiel`/`povBackgroundIndoor`/`povFog`) — et un second propriétaire
          en peindrait deux l'un sur l'autre. */}
