...
export const icons: IconFamily = [
  ...
  },
  {
    ...
    label: 'Munition',
    svg:
      `<path ${K} d="M9.1 10.3 C8.7 13.6 9 16.9 9.9 19.9 C11.3 20.3 12.7 20.3 14.1 19.9 C15 16.9 15.3 13.6 14.9 10.3"/>` +
      `<path ${K} d="M9.1 10.3 C11 9.7 13 9.7 14.9 10.3"/>` +
      `<path ${KF} d="M11 9.7 L10.3 4.2 M13.2 9.6 L14 4.4"/>` +
      `<path ${F} d="M10.3 2.9 C10.9 3.6 11.1 4.4 11 5.3 C10.3 4.9 9.8 4.2 9.6 3.3 Z"/>` +
      `<path ${F} d="M14 3.1 C14.4 4 14.3 4.9 13.8 5.7 C13.2 5 12.9 4.2 13 3.3 Z"/>`,
  },
  {
    id: 'item/cloak',
    label: 'Cape',
