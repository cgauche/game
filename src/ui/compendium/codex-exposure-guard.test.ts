...
const FILE_TO_CATEGORY_KEYS: Record<string, string[]> = {
  ...
  'combat-stakes.json': ['combatStakes'],
...
const CODEX_EXPOSURE_EXEMPT: Record<string, string> = {
  ...
  'sizes.json': 'trois barèmes par Taille (`rangedMod`/`shipboardEnc`/`footprintSide`) — vocabulaire structurel, pas une fiche narrative.',
