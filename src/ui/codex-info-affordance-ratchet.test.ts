 ...
 *    la fenêtre (#1117, arbitrage user 2026-08-06 : « Je pensais que tu allais mettre un "i" a coté de
 *    "Cauchemars", pas "la régle" en dessous »). SOURCE UNIQUE du déclencheur pour toutes les surfaces
 *    d'enjeu (cascades ET modales mono) — le stock reste à 1 alors que les porteurs se multiplient.
 *    Le « faut pas mettre de i » de #1078 visait l'ⓘ POSÉ À CÔTÉ d'un contrôle qui porte déjà sa
 *    règle ; un TITRE n'est pas un contrôle et n'a aucune chip à englober — sans lui, la règle du jet
 *    n'a plus de porte. Les chips de la même fenêtre restent leurs propres portes.
