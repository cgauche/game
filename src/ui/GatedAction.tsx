 ...
 * « Commencer » — #371) : tout bouton principal désactivé pour une raison intelligible la COMPOSE au
 * lieu d'un `<button disabled title=…>` muet. Pose `.gated-action` (components.css).
 */
