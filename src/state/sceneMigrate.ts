...
/** Migre toutes les entités d'une scène (kind + ancien loot/search). PUR (ne mute pas l'entrée).
 *  Les rencontres sont déjà en `members` (cf. `buildEncounter` à l'authoring) — plus de
 *  normalisation d'ennemis inline au chargement. */
