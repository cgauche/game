...
describe('Incantation opposée (SpellSpec.opposed — multijet)', () => {
  ...
  function frozenCast(H: Combatant, E: Combatant, label: string, sl: number) {
    useGame.setState({
      pendingCast: {
        casterId: H.id, targetId: E.id, spellLabel: label, missile: false, focused: false,
