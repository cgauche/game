...
/**
 * VOYAGE FLUVIAL (T2C 7) — la descente du Reik en barge JOUÉE jour par jour. Depuis la Phase B, TOUS
...
/**
 * BARRAGE de débris (T2C 7 l.128) — CHOIX joueur : forcer au bélier (+10 Dégâts à la coque) ou déblayer
...
describe('exposition hydrique de la descente (T2C 16) — l\'Effet waterExposure EXERCÉ après le jour', () => {
  ...
  it('un héros peut CONTRACTER la maladie sur échec du Test d\'Exposition (contraction directe, T2C 16)', () => {
