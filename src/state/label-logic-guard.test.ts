...
const RATCHET_EXCEPTIONS: Record<string, string> = {
  ...
  'ui/compendium/CompendiumScreen.tsx:78': 'CodexItem (registry.ts) agrège ~20 catégories hétérogènes SANS id unifié — le Codex, navigateur de référence en LECTURE SEULE, sélectionne par label par construction.',
  'ui/compendium/CompendiumScreen.tsx:80': 'idem CompendiumScreen.tsx:78 (CodexItem sans id unifié).',
  'ui/compendium/CompendiumScreen.tsx:122': 'idem CompendiumScreen.tsx:78 (CodexItem sans id unifié).',
