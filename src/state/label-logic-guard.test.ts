...
const RATCHET_EXCEPTIONS: Record<string, string> = {
  ...
  'ui/InterludeScreen.tsx:690': "LearnPane : recherche par texte tapé (motif `RefField` freeText) sur `LearnOption` qui PORTE un id (`sel.id`) — migration possible vers id-first mais composant de saisie à refactorer, hors périmètre garde.",
