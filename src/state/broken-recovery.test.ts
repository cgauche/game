...
function broken(over: Partial<Combatant>): Combatant {
  return { id: 'h', kind: 'hero', name: 'H', pos: { x: 1, y: 1 }, conditions: [{ name: 'Brisé', value: 2 }], characteristics: { FM: 80 }, skills: [], engagedWith: [], wounds: { current: 10, max: 10 }, ...over } as unknown as Combatant;
}
