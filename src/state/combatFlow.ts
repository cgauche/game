/**
 * Flux de combat (tour par tour) — fonctions extraites de store.ts pour le garder navigable.
 * Toutes prennent (get, set) et mutent le BattleState ; appellent les actions du store via get().
 * RNG partagé via ./battleRng. Aucun changement de comportement (refacto pure).
 */
