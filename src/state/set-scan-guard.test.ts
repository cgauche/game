...
// +1 (#1411 P1 : `dispelSelectCarrier` (`combatSlice.ts`) POSE le PORTEUR élu du mode Dissiper —
// `dispelCarrierId`, à la RACINE du store comme `localIntent` et `refus`, parce que c'est un choix
// d'ÉCRAN et non un état de combat : d'où un `set()` de racine et non une mutation de la coquille
// `battle`. Aucun reset ad hoc de plus : `dispelCarrierId` n'est pas une clé de STATE_FIELDS.
// Mesure exacte 740/301).
