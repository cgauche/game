 ...
 * = `slugId(QualityDef.key)`) : ce que la DONNÉE et le runtime (`ItemInstance/Weapon.qualities`)
 * stockent. `hasQuality`/`indiceOf`/`qualityIndice` comparent désormais par cet id.
 *
