...
function hero(p: Partial<Combatant> = {}): Combatant {
  return {
    ...
    skills: [
      { name: 'Prière', advances: 10 }, { name: 'Langue', spec: 'Magick', advances: 10 },
      { name: 'Focalisation', advances: 10 },
    ] as never,
    talents: [],
    ...p,
  } as Combatant;
...
describe('castPenalty — pénalités/blocages temporisés', () => {
  ...
  it('« Pensez à vos actes » : tout Test de Prière RÉUSSI plafonné à 0 DR', () => {
    ...
    const prayer = { label: 'Bénédiction de Guérison', type: 'Béni', cn: null, desc: 'soin' };
