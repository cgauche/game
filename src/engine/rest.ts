 ...
 *  - `opts.disease` : SCOPE par id (Gesundheit → une `blessure-purulente` seulement, MSRC 4 p.13 ;
 *    Rouille mouchetée → `verole-du-tanneur`, MSRC 4 p.14) ; absent = la première maladie active.
