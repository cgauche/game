...
describe('items — recomputeLoadout / encombrement', () => {
  ...
  it("totalEncumbrance : un objet `sizeFor` plus grand que Moyenne compte l'Enc ×2 (ADE II 2 l.708 — « la version ogre… vaut deux fois l'Encombrement classique »)", () => {
  ...
  it("totalEncumbrance : `sizeFor` Moyenne (ou absent) ne double PAS — catalogue nativement ogre (ADE II 2 l.604)", () => {
