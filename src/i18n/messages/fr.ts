...
export const fr = {
  ...
  'tra.handSevered': '{name} : 4+ doigts perdus ({loc}) → règle de la main tranchée.',
  'tra.locSuffix': '{label} ({loc})',
  'tra.medicalAid': "{name} reçoit de l'Aide Médicale — l'aggravation de la blessure est stoppée.",
  'tra.fingerLost': '{name} : sans Aide Médicale, la main perd un doigt de plus ({loc}).',
  ...
  'tra.blindness': '{name} perd la vue (cécité) — −30 aux Tests liés à la vue.',
  'tra.deafness': "{name} perd l'ouïe (surdité) — −20 aux Tests de Perception basés sur l'ouïe.",
