...
export const fr = {
  ...
  'party.recruit.pool': "Candidats à l'aventure",
  'party.recruit.intro': 'Choisissez un candidat pour pourvoir le prochain siège libre, ou créez le vôtre.',
