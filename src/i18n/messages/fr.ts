...
export const fr = {
  ...
  'cond.derivedSrcFallback': 'un mal qu’il traîne',
  'cond.refusDeterminationVerrou': '{cond} ne se lèvera pas avant la guérison ({src}).',
  ...
  'op.money': '{name} {sens} {montant} ({src}).',
  'op.money.gagne': 'gagne',
  'op.money.perd': 'perd',
  ...
  'op.arrowWard': '{name} dresse un bouclier anti-flèches sur {diametre} m de diamètre : les projectiles organiques qui y entrent sont détruits ({src}).',
  'op.arrowWardCouvert': '{name} est sous le bouclier anti-flèches.',
  'op.domeWard': '{name} érige un dôme sur {diametre} m de diamètre : il octroie {trait} contre les attaques magiques ou à distance venant de l’extérieur ({src}).',
  'op.domeWardCouvert': '{name} est sous le dôme : {trait}.',
  'cf.wardSaved': '{name} ignore le coup — sauvegarde 1d10 : {roll} ≥ {trait}{src}.',
  'cf.wardFailed': '{name} n’ignore pas le coup — sauvegarde 1d10 : {roll} < {trait}{src}.',
  'cf.wardFromDome': ' du Dôme',
  'cf.wakeSleeper': '{name} réveille {foe} en l’attaquant — le sommeil se rompt.',
  'cf.arrowWardDestroys': 'Le projectile se désagrège en entrant dans la zone — {name} est indemne (Bouclier anti-flèches).',
  'cf.martyrTakes': 'Martyr : {priest} reçoit les Dégâts à la place de {name} ({taken} PB, BE doublé).',
  'cf.pushback': '{name} repousse {foe} de {meters} m (Perturbante{bloque}).',
  'cf.pushbackBlocked': ' — recul bloqué',
  ...
  'dz.symptomAttenuated': '{name} : le symptôme {symptom} de « {disease} » s’atténue.',
  ...
  // de la ligne de jet, qui porte la pénalité en clair (#1685).
  ...
  'shipCrit.crewNoneExposed': "Coup à l'Équipage, aucun marin exposé : le coup porte sur {loc}.",
  ...
  'key.editeurRotL': 'Éditeur : tourner la vue à gauche',
  'key.editeurRotR': 'Éditeur : tourner la vue à droite',
  'key.editeurPan': 'Éditeur : déplacer la vue (maintenir + glisser)',
  'key.editeurAnnuler': 'Éditeur : annuler',
  'key.editeurRetablir': 'Éditeur : rétablir',
  'key.editeurRetablirMaj': 'Éditeur : rétablir (Maj)',
  'key.editeurCopier': 'Éditeur : copier la sélection',
  'key.editeurColler': 'Éditeur : coller',
  'key.editeurDupliquer': 'Éditeur : dupliquer la sélection',
  'key.editeurSupprimer': 'Éditeur : supprimer la sélection',
  'key.editeurNudgeUp': 'Éditeur : décaler la sélection vers le haut',
  'key.editeurNudgeDown': 'Éditeur : décaler la sélection vers le bas',
  'key.editeurNudgeLeft': 'Éditeur : décaler la sélection vers la gauche',
  'key.editeurNudgeRight': 'Éditeur : décaler la sélection vers la droite',
  'key.editeurEchap': 'Éditeur : fermer le menu ouvert, sinon désélectionner',
  'key.named.space': 'Espace',
  'key.named.enter': 'Entrée',
  'key.named.numpadEnter': 'Entrée (pavé)',
  'key.named.escape': 'Échap',
  'key.named.delete': 'Suppr',
