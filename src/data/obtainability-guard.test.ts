 ...
 * - `benediction-de-tzeentch`/`disciple-du-changement`/`double-vie` (EDOC ch.13 « La Main pourpre »
 ...
 * - `empreint-de-la-magie` (EDOC ch.13 « Influence Maléfique de Tzeentch » l.248-258) : octroyé comme
 ...
 * - `magie-du-chaos` (LDB 10 p.140 l.702-710 ; carrière concrète EDOC ch.13 l.137 « Magus du Culte de
