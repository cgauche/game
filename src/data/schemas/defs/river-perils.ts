/**
 * Schéma de `river-perils.json` — Dangers fluviaux (T2C 7 l.119-166 : Débris/Barrage/Rochers/Eaux
  ...
  perils: z.array(
    z.strictObject({
      ...
      obstacle: z
        ...
        .optional(),
      /** Déblayage à la main (T2C 7 l.128 : `objects` = 3d10 éléments de `encPerObject` = 4d10 Enc) ;
       *  `encPerHour` = débit de halage, valeur maison éditable (T2C 7 l.128, règle stricte 7). */
      clear: z
