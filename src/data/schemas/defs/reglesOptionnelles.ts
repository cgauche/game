 ...
 * plus précise dont on dispose. Mesuré au 2026-08-16 : 68 entrées en `<ABRÉV> <ch> l.<ligne>`, 11 au
 * CHAPITRE seul (le passage ne chiffre rien à pointer — `LDB 18`, `LDB 65`, `EDOC 12`…), 2 au folio
 ...
 * `castingNumberMod.maison`, `common.ts`) — 26 entrées.
 ...
 */
import { z } from 'zod';
import { ruleValueSchema } from '../common';
