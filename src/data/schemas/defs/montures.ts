/**
 * Schéma de `montures.json` — Mouvement/Endurance des montures/bêtes de trait en VOYAGE (EDOC ch.07
...
export const schema = z.strictObject({
  ...
  entries: z.array(
    z.strictObject({
      ...
      e: z.number(),
      /** Peut trotter (allure plus rapide sur route, EDOC ch.07) — `false` pour les bêtes de trait/somme. */
      trot: z.boolean(),
