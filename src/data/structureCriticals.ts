 ...
 * Navire suivent le MÊME patron Endurance/Blessures + table de Critiques (AA l.3690).
 *
 ...
 *    AA l.2523 ; `null` quand la Structure est `destroyed`).
...
export interface StructureCritEntry {
  ...
  wounds: number | null;
  /** Blessure Triviale (« T », AA l.2523) : 0 Blessure, ne compte pas vers la destruction. */
  trivial?: boolean;
