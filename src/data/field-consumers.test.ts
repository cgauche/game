...
const RECOUVRES: readonly (readonly [string, string, string])[] = [
  ...
  ['CritEscalation', 'onRepeat', 'src/engine/critical.ts:259'],
  ['Amputation', 'timing', 'src/engine/critical.ts:273'],
  ['FlowTest', 'opposed', 'src/state/combat/triggeredTest.ts:293'],
  ['CountSpec', 'fixed', 'src/data/index.ts:3435'],
  ['CountSpec', 'roll', 'src/data/index.ts:3435'],
