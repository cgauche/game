...
const TETE: CritTable = [
  ...
  { min: 51, max: 55, name: 'Mâchoire fracturée', wounds: 3, conditions: [SO(2)], note: 'Traumatisme Fracture (Mineure).' },
  ...
  { min: 71, max: 75, name: 'Mâchoire cassée', wounds: 4, conditions: [SO(3)], resist: { difficulty: 'intermediaire', onFail: [INC()] }, note: 'Traumatisme Fracture (Majeure).' },
  ...
  { min: 97, max: 99, name: 'Mâchoire mutilée', wounds: 5, conditions: [H(4), SO(3)], resist: { difficulty: 'tresDifficile', onFail: [INC()] }, note: 'Fracture (Majeure), perte de la langue et 1d10 dents — Amputation (Difficile).' },
...
const BRAS: CritTable = [
  ...
  { min: 21, max: 25, name: 'Torsion', wounds: 1, note: 'Traumatisme Déchirure musculaire (Mineur).' },
  { min: 26, max: 30, name: 'Choc violent au bras', wounds: 2, note: 'Lâchez ; main inutilisable 1d10-(BE) Rounds (min 1).' },
  { min: 31, max: 35, name: 'Déchirure musculaire', wounds: 2, conditions: [H()], note: 'Traumatisme Déchirure musculaire (Mineur).' },
  ...
  { min: 51, max: 55, name: 'Cassure nette', wounds: 3, resist: { difficulty: 'complexe', onFail: [SO()] }, note: 'Lâchez ; Traumatisme Fracture (Mineure).' },
  { min: 56, max: 60, name: 'Ligament rompu', wounds: 3, note: 'Lâchez ; Traumatisme Déchirure musculaire (Majeur).' },
  { min: 61, max: 65, name: 'Coupure profonde', wounds: 3, conditions: [H(2), SO()], resist: { difficulty: 'difficile', onFail: [INC()] }, note: 'Déchirure musculaire (Mineur).' },
  ...
  { min: 71, max: 75, name: 'Coude fracassé', wounds: 4, note: 'Lâchez ; Traumatisme Fracture (Majeure).' },
  ...
  { min: 91, max: 93, name: 'Biceps déchiqueté', wounds: 5, conditions: [H(2), SO()], note: 'Lâchez ; Traumatisme Déchirure musculaire (Majeur).' },
...
const CORPS: CritTable = [
  ...
  { min: 26, max: 30, name: 'Torsion du dos', wounds: 1, note: 'Traumatisme Déchirure musculaire (Mineur).' },
  ...
  { min: 51, max: 55, name: 'Côtes fracturées', wounds: 3, conditions: [SO()], note: 'Traumatisme Fracture (Mineure).' },
  ...
  { min: 71, max: 75, name: 'Dos froissé', wounds: 4, note: 'Traumatisme Déchirure musculaire (Majeur).' },
  { min: 76, max: 80, name: 'Hanche fracturée', wounds: 4, conditions: [SO()], resist: { difficulty: 'intermediaire', onFail: [AT()] }, note: 'Traumatisme Fracture (Mineure).' },
  ...
  { min: 91, max: 93, name: 'Cage thoracique perforée', wounds: 5, conditions: [SO()], note: 'Sonné retiré uniquement par Aide Médicale ; Traumatisme Fracture (Majeure).' },
  { min: 94, max: 96, name: 'Clavicule cassée', wounds: 5, conditions: [INC()], note: 'Inconscient jusqu’à Aide Médicale ; Traumatisme Fracture (Majeure).' },
...
const JAMBE: CritTable = [
  ...
  { min: 36, max: 40, name: 'Cheville foulée', wounds: 2, note: 'Traumatisme Déchirure musculaire (Mineur).' },
  ...
  { min: 56, max: 60, name: 'Genou méchamment tordu', wounds: 3, note: 'Traumatisme Déchirure musculaire (Majeur).' },
  { min: 61, max: 65, name: 'Jambe charcutée', wounds: 3, conditions: [H(2), AT()], resist: { difficulty: 'difficile', onFail: [SO()] }, note: 'Traumatisme Fracture (Mineure).' },
  ...
  { min: 71, max: 75, name: 'Tendon rompu', wounds: 4, conditions: [AT(), SO()], resist: { difficulty: 'difficile', onFail: [INC()] }, note: 'Jambe inutilisable ; Traumatisme Déchirure musculaire (Majeur).' },
  { min: 76, max: 80, name: 'Entaille au tibia', wounds: 4, conditions: [SO(), AT()], note: 'Traumatismes Déchirure musculaire (Majeur) et Fracture (Majeure).' },
  { min: 81, max: 85, name: 'Genou cassé', wounds: 4, conditions: [SO(), AT()], note: 'Traumatisme Fracture (Majeure).' },
