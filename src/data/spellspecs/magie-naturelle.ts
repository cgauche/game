...
export const MAGIE_NATURELLE: SpellSpec[] = [
  {
    ...
    ops: [{ op: 'narrative', text: 'Bonne Volonté : dans la ZdE (BSoc m), tous les Tests de Sociabilité gagnent +10 et les Traits Psychologiques Animosité et Haine sont neutralisés — arbitrage MJ.' }],
  ...
  },
  {
    ...
    ops: [{ op: 'narrative', text: 'Charme protecteur : la breloque imprégnée confère le Talent Résistance à la magie à qui la porte, pour la durée (jours) — arbitrage MJ.' }],
  ...
  },
  {
    ...
    ops: [{ op: 'narrative', text: 'Chevaucher l’Obscurité : votre esprit quitte votre corps (qui reste immobile et insensible) et explore les environs en témoin invisible, traversant les obstacles non magiques — arbitrage MJ.' }],
  ...
  },
  {
    ...
    ops: [{ op: 'narrative', text: 'Nepenthès : un philtre qui, bu tant que le Sort est actif, permet à la cible d’oublier définitivement un individu de son choix — arbitrage MJ.' }],
  ...
  },
  {
    ...
    ops: [{ op: 'narrative', text: 'Panacée : la décoction enchantée, bue tant que le Sort dure, guérit BFM Blessures et 1 maladie (+1 maladie par +2 DR) — arbitrage MJ (effet à l’ingestion).' }],
    durationRounds: null, // « (Bonus de Force Mentale) Rounds »
    curated: true,
  ...
  },
  {
    ...
    ops: [{ op: 'narrative', text: 'Séparer les branches : vous voyez dans le Monde des Esprits (créatures invisibles, esprits, démons, êtres normalement impossibles à repérer) — arbitrage MJ.' }],
    durationRounds: null, // « (Bonus de Force Mentale) minutes »
    curated: true,
