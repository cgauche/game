...
/** Bénédiction « +10 en X pendant 6 rounds » (12 des 19 suivent ce gabarit exact). Les EFFETS
 *  (charMod +10) vivent désormais sur `SpellData.effects` — la spec ne garde que les métadonnées. */
const plus10 = (label: string, source: string): SpellSpec => ({
  label,
  durationRounds: 6,
  curated: true,
  source,
...
export const BENEDICTIONS: SpellSpec[] = [
  plus10('Bénédiction de Bataille', '« Votre cible gagne +10 en Capacité de Combat »'),
  plus10('Bénédiction de Charisme', '« Votre cible gagne +10 en Sociabilité »'),
  plus10('Bénédiction de Courage', '« Votre cible gagne +10 en Force Mentale. »'),
  plus10('Bénédiction de Finesse', '« Votre cible gagne +10 en Dextérité. »'),
  plus10('Bénédiction de Grâce', '« Votre cible gagne +10 en Agilité. »'),
  plus10('Bénédiction de La Chasse', '« Votre cible gagne +10 en Capacité de Tir. »'),
  plus10('Bénédiction de Puissance', '« Votre cible gagne +10 en Force. »'),
  plus10('Bénédiction de Sagesse', '« Votre cible gagne +10 en Intelligence. »'),
  plus10('Bénédiction de Vigueur', '« Votre cible gagne +10 en Endurance. »'),
  plus10('Bénédiction de Vivacité', '« Votre cible gagne +10 en Initiative. »'),
  {
  ...
  },
  {
    ...
    // « retirer 1 État » — au choix de la cible (nom absent)
    durationRounds: null, // Instantanée
    curated: true,
  ...
  },
  {
    ...
    // (op augmentWeapon → isMagicWeapon → touche l'Éthéré, LDB 85).
    durationRounds: 6,
    curated: true,
