...
Lié à [[game-monture-composite-profondeur]], [[game-footprint-multicases]], [[game-combat-keyboard-gamepad]], [[feedback-arbitrage-agent-source-en-main]] — une remarque user « pas RAW » se vérifie à l'Atlas AVANT d'agir : ici elle n'était vraie qu'à moitié, et la vérification a évité de casser le destrier.
