...
2. Le front rigs passe en mode **ciblé-unitaire** : une créature à la fois, sur demande user, un seul artiste Fable, jugement par l'user lui-même sur planche (pas de panel de juges vision payant). Précision user 2026-07-16 (verbatim) : « Geste d'art unitaire autorisé » — un trait/une part/une déclinaison de vues à la fois passe SOUS le gel sans re-demander ; seules les VAGUES restent gelées.
