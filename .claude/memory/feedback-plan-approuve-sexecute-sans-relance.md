...
3. Le red flag correspondant vit dans le skill `orchestrer-des-agents` (un skill, pas une fiche — pas de lien [[…]]) ; la même discipline vaut pour les DoD de tickets (voir [[feedback-regle-1-jamais-commit-avec-reste-ouvert]], [[feedback-avancer-en-autonomie-jamais-serialiser]]).
