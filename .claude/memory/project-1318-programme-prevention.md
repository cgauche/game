...
**17 LOTS LIVRÉS au 2026-08-16 soir** : V3-V7, V10, V8d-0/A, V8a₀ (murage PlayerText aux 7 portes), V8a₁ (85 rawText prod→1, fabriques step.*/opt.*, dataLabel/refConcrete), V9 (81 règles en donnée + VDM + édition Codex typée, dette folios E8=55), V8b+V8c₀ (séquence au catalogue + prédicat francité durci #1333 CLOS, baseline 275, garde de parité committée), V8b₂ (7 positions séquence PlayerText — un template FR ne compile plus). **Reprise** : V8c de masse (baseline i18n 275→0 par flux = E5), V8d-B/C/D (#1330 — canal onCondition posé, l'appariement ligne↔id reste LE design à trancher ; + ARRAY_SEED élargi aux log non annotés, sonde du juge), E1-E8 (cibles zéro nommées au ticket), gatedByRule, design S4-c. Fossile rawText gelé 139 (E7 : fixtureText muré par chemin d'import, 3 conditions du juge).

**E5 ÉTEINT** (2026-08-17, V8c₁-₅ : 5e007820→e2fd8b0f) — baseline i18n 275→ZÉRO en 5 tranches, ~950 sites à parité d'octet (garde de 134 oracles sur la production), le prédicat passé de 6 à 8 formes (chaque forme née d'un trou révélé), 11 bugs de gameplay fermés en chemin + 1 P1 de save pris par le juge AVANT commit (migration v24→25 passiveKind + filet). Tickets de la série : #1340, #1341 FERMÉ, #1342 (387 specs par libellé dans creatures.json — bonus de navigation morts), #1346 (canal menace par label mort). **Reprise** : V8d-B/C/D (#1330 — l'appariement ligne↔id = le design à trancher, + ARRAY_SEED élargi), E1-E4/E6-E8 (cibles zéro nommées), gatedByRule, design S4-c. Le ticket fait foi.
