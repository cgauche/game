---
name: user-arbitrage-navires-combattants
description: Arbitrage 2026-07-16 — les navires SONT des combattants (modèle navire-unité confirmé) ; les 3 trous connus deviennent exécutables
metadata: 
  node_type: memory
  type: feedback
...
Arbitrage utilisateur (2026-07-16, verbatim) : « Les navires sont des combattants oui, c'est
déjà le cas non ? »
