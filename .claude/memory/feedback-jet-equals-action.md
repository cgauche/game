...
- l'acte ne demande **aucun jet** → ce n'est **pas** une Action, c'est **juste du Mouvement** (« sinon c'est juste du mouvement non ? ») → consomme `battle.moved`.
