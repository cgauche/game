...
**RAW (ne jamais réinventer) :** valeurs verbatim de `14 - _GoBack.md` (Difficultés de Combat l.77-136, Combiner l.126-131) + `13 - Combat.md` l.123 (LdV) + `85 - Traits de créature.md` l.301-303 (+10 plus petit). Table NON exhaustive → l.75 autorise l'extrapolation (décor/créature-couvert documentés `[DESIGN]`). Cf. CLAUDE.md règle 7 « Pas de MJ » + [[game-francais-jamais-anglais]].
