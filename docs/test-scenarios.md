...
| 🐲 Créatures | 🐲 Aspersion — créature marine hors de l'eau | Action « Asperger d'eau » (MDG 16 l.19, #497) : une anguille mâcheprise échouée sur la terre (`offTerrain`, aucune tuile d'eau) suffoque Round après Round (`suffocationTick`, #477) sauf si le Soldat, outre à eau en poche, l'asperge à portée adjacente (`battleWater`, aucun jet) |
