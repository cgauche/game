...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 85` (l.343-406) → `creatureWeapon`, `cannotStopOn`, `agressifEnvers`, `fearSourceFor`, `weaponFromTrait`, `EnemyTurnInput`, `woundsForSize`, `displaceSmaller`, `MoveEnv`, `peurTerreurFromSize`, +27 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/regles.json`, `src/data/traits.json`, `src/engine/creatureEquip.ts`, `src/engine/psychology.ts`, +7 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 85` (l.276-277, l.339-340) → `creatureWeapon`, `StatblockEditor`, `fearSourceFor`, `woundsForSize`, `resizeBySteps`, `resolvePsychAI`, `creatureToCombatant`, `taille-modificateurs-en-combat`, `bestDefenseMode`, `SpecsSource`, +19 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/regles.json`, `src/data/traits.json`, `src/engine/creatureEquip.ts`, `src/engine/psychology.ts`, +6 fichiers
...
- `LDB 85` (l.357-387) → `cannotStopOn`, `agressifEnvers`, `fearSourceFor`, `weaponFromTrait`, `EnemyTurnInput`, `woundsForSize`, `displaceSmaller`, `MoveEnv`, `peurTerreurFromSize`, `availableAttacks`, +8 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/regles.json`, `src/data/traits.json`, `src/engine/creatureEquip.ts`, `src/engine/psychology.ts`, +7 fichiers
