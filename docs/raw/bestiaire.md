...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 76` (l.28-35) → `STANDARD_OPTIONALS`, `aaTableFor`, `resolveAACritical`, `sceneEntitySchema`, `SceneEntity`, `criticalTableFor`, `SpawnExtras`, `critTableKeyFor`, `creatureToCombatant`, `rollCritical`, +1 — `src/data/criticals.ts`, `src/data/index.ts`, `src/data/schemas/defs-scenes/scene.ts`, `src/engine/aaCritical.ts`, `src/engine/critical.ts`, `src/state/scene.ts`, +2 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 76` (l.31-35, l.37) → `STANDARD_OPTIONALS`, `aaTableFor`, `resolveAACritical`, `sceneEntitySchema`, `SceneEntity`, `criticalTableFor`, `SpawnExtras`, `critTableKeyFor`, `creatureToCombatant`, `rollCritical`, +1 — `src/data/criticals.ts`, `src/data/index.ts`, `src/data/schemas/defs-scenes/scene.ts`, `src/engine/aaCritical.ts`, `src/engine/critical.ts`, `src/state/scene.ts`, +2 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 76` (l.31-35) → `STANDARD_OPTIONALS`, `aaTableFor`, `resolveAACritical`, `sceneEntitySchema`, `SceneEntity`, `criticalTableFor`, `SpawnExtras`, `critTableKeyFor`, `creatureToCombatant`, `rollCritical`, +1 — `src/data/criticals.ts`, `src/data/index.ts`, `src/data/schemas/defs-scenes/scene.ts`, `src/engine/aaCritical.ts`, `src/engine/critical.ts`, `src/state/scene.ts`, +2 fichiers
