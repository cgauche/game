...
**Couverture (profondeur) : ✅ 87 traités par une fiche · 📖 66 transcrits par un catalogue seul (jamais traités) · 🟡 2 effleurés · ⬜ 15 trous** sur 170 chapitres-règles (hors artefacts OCR). Section-granulaire (niveau de heading ADAPTATIF par livre — H2 pour AA/ADE I/ADE II/EDO, H3 pour LDB/MCLB/ACE/EDOC/MSRC/MSR/PDT/NADJ/MDG/ZI, H4 pour AU1, #604), ventilation DÉRIVÉE (jamais un compte recopié) sur 3408 section(s) non couvertes par une fiche : **635 transcrite(s) en catalogue** (recopiées, pas traitées) · **2450 hors-règle** (chapitre explicitement exclu) · **58 bruit de scénario** (livres `SCENARIO_PUR` EDO/MSR/PDT/AU1 : prose de campagne, aucune règle) · **265 candidat(s) trou de règle** (reste : livres de règles + compagnons mixtes ACE/NADJ/ADE/MCLB/EDOC/MSRC/MDG, où une section vide peut cacher une vraie règle non couverte) — et 5 titre(s) de chapitre enfoui(s) détecté(s) (titre orné rétrogradé par l'extraction). Ce chiffre reste un PLANCHER : les sections couvertes par une fiche (✅ au niveau section) ne sont pas dénombrées ici (volume, cf. #604 DoD « la sortie ne liste pas l'exhaustif »). Réfs folio (`ABBR NN p.X`, #606) : 3 ignorée(s) proprement (ancre absente/ambiguë/hors-chapitre). Par livre : LDB ✅40·📖32·🟡1·⬜0 · ADE I ✅0·📖2·🟡0·⬜0 · ADE II ✅3·📖3·🟡0·⬜0 · AA ✅10·📖3·🟡0·⬜0 · ZI ✅4·📖10·🟡0·⬜0 · MCLB ✅0·📖5·🟡0·⬜0 · EDO ✅3·📖0·🟡0·⬜0 · EDOC ✅4·📖0·🟡1·⬜0 · MSR ✅0·📖1·🟡0·⬜0 · MSRC ✅4·📖4·🟡0·⬜0 · PDT ✅2·📖2·🟡0·⬜0 · ACE ✅1·📖2·🟡0·⬜0 · AU1 ✅1·📖0·🟡0·⬜0 · NADJ ✅6·📖0·🟡0·⬜0 · MDG ✅9·📖2·🟡0·⬜0 · VDM ✅0·📖0·🟡0·⬜15.
...
- **LDB 08** (Statut) :
  ...
  - 📖 l.1183-1192 « Garde – Argent 2 » — transcrit en catalogue, jamais traité, 0 réf
  - 📖 l.1193-1365 « Garde d'honneur – Argent 3 » — transcrit en catalogue, jamais traité, 0 réf
  - 📖 l.1366-1581 « Sergent – Argent 5 » — transcrit en catalogue, jamais traité, 0 réf
...
- **LDB 44** (L’Aethyr) :
  ...
  - ⬜ l.92-124 « Domaine de la Vie » — candidat trou de règle, 0 réf
...
|---|---|---|---|
| 00 | Index | ➖ hors-règle | |
| 01 | Contes de sorcellerie | ⬜ |  |
| 02 | Révisions des règles d'incantation | ⬜ |  |
| 03 | Travaux arcaniques | ⬜ |  |
| 04 | Hysh — Domaine de la Lumière | ⬜ |  |
| 05 | Chamon — Domaine du Métal | ⬜ |  |
| 06 | Ghyran — Domaine de la Vie | ⬜ |  |
| 07 | Azyr — Domaine des Cieux | ⬜ |  |
| 08 | Ulgu — Domaine des Ombres | ⬜ |  |
| 09 | Shyish — Domaine de la Mort | ⬜ |  |
| 10 | Aqshy — Domaine du Feu | ⬜ |  |
| 11 | Ghur — Domaine de la Bête | ⬜ |  |
| 12 | Artefacts magiques | ⬜ |  |
| 13 | Créatures magiques | ⬜ |  |
| 14 | Les Vents à l'œuvre | ⬜ |  |
| 15 | Némésis et aventures magiques | ⬜ |  |

**Sections trouées/cataloguées/enfouies** (niveau de heading H2) :

- **VDM 09** (Shyish — Domaine de la Mort) :
  - ⬜ l.375-536 « Le Labyrinthe de Cristal » — candidat trou de règle, 0 réf
