...
- `LDB 21` (l.5-11) → `supersededLines`, `createCombatSlice`, `collectHeroRoundStartPsych`, `openRoundStartPsych` — `src/data/combat-stakes.json`, `src/engine/psychology.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 21` (l.8-11) → `supersededLines`, `createCombatSlice`, `collectHeroRoundStartPsych`, `openRoundStartPsych` — `src/data/combat-stakes.json`, `src/engine/psychology.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 21` (l.18-21) → `ApproachModal`, `supersededLines`, `describeApproach`, `EffectFlags`, `BattleState`, `isFrenzyCapable`, `resolvePeurTest`, `ActionBar`, `extendedTestStep`, `attackClickCommit`, +21 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/engine/psychology.ts`, `src/engine/tests.ts`, `src/engine/types.ts`, +12 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 21` (l.23-28) → `ApproachModal`, `FrenzyModal`, `hasMeaningfulOption`, `supersededLines`, `aiMaybeFrenzy`, `availableFreeAttackOps`, `Condition`, `describeApproach`, `isPsychImmune`, `EffectFlags`, +40 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/engine/combat.ts`, `src/engine/flowCore.ts`, `src/engine/ops.ts`, +20 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 21` (l.28-33, l.35) → `ApproachModal`, `FrenzyModal`, `hasMeaningfulOption`, `supersededLines`, `aiMaybeFrenzy`, `availableFreeAttackOps`, `Condition`, `describeApproach`, `isPsychImmune`, `EffectFlags`, +39 — `src/data/flow-stakes.json`, `src/data/index.ts`, `src/engine/combat.ts`, `src/engine/flowCore.ts`, `src/engine/ops.ts`, `src/engine/psychology.ts`, +19 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 21` (l.37-39, l.41) → `ApproachModal`, `FrenzyModal`, `hasMeaningfulOption`, `nightmare`, `terreur`, `calme-d-approche`, `aiMaybeFrenzy`, `availableFreeAttackOps`, `Condition`, `describeApproach`, +38 — `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/night-stakes.json`, `src/data/psychology.json`, `src/data/regles.json`, `src/data/traits.json`, +23 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 85` (l.166, l.178-180) → `scene`, `planClimb`, `scenario`, `TraverseCapability`, `Formula`, `moveEnv`, `EnemyTurnInput`, `Condition`, `availableAttacks`, `engagedAdvantageGap`, +54 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/qualities.json`, `src/data/traits.json`, `src/engine/flowCore.ts`, `src/engine/magic.ts`, +11 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 85` (l.253, l.266) → `StatblockEditor`, `fearSourceFor`, `resizeBySteps`, `resolvePsychAI`, `creatureToCombatant`, `immunite-psychologique`, `increvable`, `infecte`, `infravision`, `insensible-a-la-douleur`, +33 — `src/data/maneuvers.json`, `src/data/traits.json`, `src/engine/psychology.ts`, `src/engine/size.ts`, `src/state/combat/turnHooks.ts`, `src/state/combatFlow.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 85` (l.274, l.282, l.382-384) → `cannotStopOn`, `StatblockEditor`, `agressifEnvers`, `fearSourceFor`, `EnemyTurnInput`, `displaceSmaller`, `resizeBySteps`, `MoveEnv`, `peurTerreurFromSize`, `resolvePsychAI`, +25 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/regles.json`, `src/data/traits.json`, `src/engine/psychology.ts`, `src/engine/size.ts`, +9 fichiers
...
- `LDB 21` (l.37-39) → `ApproachModal`, `FrenzyModal`, `hasMeaningfulOption`, `nightmare`, `terreur`, `calme-d-approche`, `aiMaybeFrenzy`, `availableFreeAttackOps`, `Condition`, `describeApproach`, +38 — `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/night-stakes.json`, `src/data/psychology.json`, `src/data/regles.json`, `src/data/traits.json`, +23 fichiers
...
- `LDB 85` (l.178-179, l.382-383) → `cannotStopOn`, `agressifEnvers`, `fearSourceFor`, `Formula`, `EnemyTurnInput`, `displaceSmaller`, `Condition`, `MoveEnv`, `peurTerreurFromSize`, `availableAttacks`, +57 — `src/data/index.ts`, `src/data/maneuvers.json`, `src/data/qualities.json`, `src/data/regles.json`, `src/data/traits.json`, `src/engine/flowCore.ts`, +10 fichiers
