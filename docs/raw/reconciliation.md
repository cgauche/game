...
### LDB 08 — 1/11 ligne(s) code hors couverture (propriétaire : docs\raw\carrieres.md)
- l.557 — `src/data/donnees.manifest.json:581` — "desc": "Réglage MAISON du rendu du couple MONTÉ (#1128) — `harnaisParDefaut` : id du set d'équipement (registre `src/gameIso/rig/quadruped/harnais/`) apposé à 
...
- `src/state/riverVoyageFlow.ts:955` (l.71) — // Sur la rivière on peut mouiller le long de la berge : coucher À BORD (hamacs, MDG 03 l.71) offert
...
- l.85 — `src/data/index.ts:2123` — *  = `totale` (MDG 12 l.364 / MSRC 12 l.85), Plat-bord = `moyenne` (MSRC 12 l.111). Géométrie de Pont,
...
- l.111 — `src/data/index.ts:2123` — *  = `totale` (MDG 12 l.364 / MSRC 12 l.85), Plat-bord = `moyenne` (MSRC 12 l.111). Géométrie de Pont,
...
### MDG 15 — 3/38 ligne(s) code hors couverture
...
- l.489 — `src/data/index.ts:1750` — *  deux natures (`VDM 12 l.646-647`, `VDM 14 l.489`). */

### EDOC 13 — 2/7 ligne(s) code hors couverture
- l.137 — `src/data/index.ts:841` — *  permission du MJ », EDOC 13 l.137 ; lignage Éonir Harioth hors espèces jouables, ADE I 6 l.185).
- l.522 — `src/data/index.ts:1346` — /** Tirage PLURIEL et ALTERNÉ de Mutations au spawn (Marque de Tzeentch, EDOC 13 l.522-524 : « gagne

### ADE I 6 — 1/1 ligne(s) code hors couverture
- l.185 — `src/data/index.ts:841` — *  permission du MJ », EDOC 13 l.137 ; lignage Éonir Harioth hors espèces jouables, ADE I 6 l.185).
