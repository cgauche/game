...
- `src/data/index.ts:848` (l.5) — *  Portée sur `gnomes` (`NADJ 14 l.5`, règle `creation-gnome-jouable`). */
...
- l.85 — `src/data/index.ts:2596` — *  = `totale` (MDG 12 l.364 / MSRC 12 l.85), Plat-bord = `moyenne` (MSRC 12 l.111). Géométrie de Pont,
...
- l.111 — `src/data/index.ts:2596` — *  = `totale` (MDG 12 l.364 / MSRC 12 l.85), Plat-bord = `moyenne` (MSRC 12 l.111). Géométrie de Pont,
...
- l.137 — `src/data/index.ts:1098` — *  permission du MJ », EDOC 13 l.137 ; lignage Éonir Harioth hors espèces jouables, ADE I 6 l.185).
...
- l.185 — `src/data/index.ts:1098` — *  permission du MJ », EDOC 13 l.137 ; lignage Éonir Harioth hors espèces jouables, ADE I 6 l.185).
...
<!-- sources-empreinte: 66c68874d532a6b882754e5c7ea26e35621a6873 (4233 fichiers, 152 dossiers) corps: 4f83f58f2e8f950b68a3b8371c53c2874648c563 -->
