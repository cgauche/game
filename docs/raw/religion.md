...
- `LDB 40` (l.35-36) → `discreetPrayerDifficulty`, `miscast-colere`, `wrath-table`, `peche`, `CastModal`, `Effect`, `prayerWrathTriggered`, `GameOp`, `prayer-conviction`, `FLOWS`, +34 — `src/data/characteristics.json`, `src/data/combat-stakes.json`, `src/data/miscast.json`, `src/data/reglesOptionnelles.json`, `src/engine/magic.ts`, `src/engine/ops.ts`, +10 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 40` (l.12-13, l.45-50) → `discreetPrayerDifficulty`, `miscast-colere`, `castInfoIsPrayer`, `castInfo`, `wrath-table`, `peche`, `liveTableDecl`, `CastModal`, `Effect`, `prayerWrathTriggered`, +43 — `src/data/characteristics.json`, `src/data/combat-stakes.json`, `src/data/miscast.json`, `src/data/reglesOptionnelles.json`, `src/engine/magic.ts`, `src/engine/miscast.ts`, +12 fichiers
