...
- `LDB 46` (l.7-10) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `hasArcaneTalent` ⚠sans-appelant, `assourdi`, `mineure-lueur-occulte`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, `mineure-delie`, +28 — `src/data/miscast.json`, `src/data/raw.manifest.json` ⚠hors-app, `src/engine/domainAttributes.ts`, `src/state/combatEffects.ts`, `src/state/partyFlow.ts`
- dette : #463
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.13-15) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `hasArcaneTalent` ⚠sans-appelant, `assourdi`, `mineure-lueur-occulte`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, `mineure-delie`, +35 — `src/data/miscast.json`, `src/engine/domainAttributes.ts`, `src/engine/magic.ts`, `src/state/combatEffects.ts`, `src/state/combatSlice.ts`, `src/state/partyFlow.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.17-21) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `hasArcaneTalent` ⚠sans-appelant, `assourdi`, `mineure-lueur-occulte`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, `mineure-delie`, +46 — `src/data/miscast.json`, `src/engine/domainAttributes.ts`, `src/engine/magic.ts`, `src/state/combatEffects.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`, +4 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.27-32) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `assourdi`, `mineure-lueur-occulte`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, `mineure-delie`, `empetre`, +46 — `src/data/miscast.json`, `src/engine/magic.ts`, `src/state/combatEffects.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`, `src/state/partyFlow.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.84-86) → `combat-spell-plus`, `lecture-au-grimoire`, `miscast-table`, `canCastFromGrimoire`, `malevolentInfluenceSeverity`, `CastPenalty`, `incantation-imparfaite`, `MISCAST_TABLE_CATEGORIES`, `applyCast`, `castNearCorruption` — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, +1 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.88-90) → `combat-spell-plus`, `lecture-au-grimoire`, `miscast-table`, `canCastFromGrimoire`, `malevolentInfluenceSeverity`, `CastPenalty`, `incantation-imparfaite`, `MISCAST_TABLE_CATEGORIES`, `applyCast`, `castNearCorruption` — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, +1 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.33-53) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `assourdi`, `MiscastResult`, `mineure-lueur-occulte`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, `mineure-delie`, +51 — `src/data/miscast.json`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`, +4 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.55-80) → `mineure-signe-de-sorciere`, `mineure-lait-caille`, `mineure-mildiou`, `assourdi`, `MiscastResult`, `mineure-lueur-occulte`, `combat-spell-plus`, `mineure-murmures-mortels`, `hemorragique`, `a-terre`, +40 — `src/data/combat-stakes.json`, `src/data/miscast.json`, `src/data/regles.json`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.129-151) → `DispelModal`, `STEP_WINDOW_AUTO`, `combat-spell-plus`, `CastableSpell`, `FocusInterruptHook`, `focalisation-etendue`, `lecture-au-grimoire`, `jetSurfaced`, `miscast-table`, `dispel-roll`, +62 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/weaponGroups.ts`, `src/engine/conditions.ts`, +22 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.139-141) → `FocusInterruptHook`, `focalisation-etendue`, `dispel-roll`, `armourCastDRPenalty`, `runCombatFlow`, `focus-interrupt`, `createCombatSlice`, `CastTestKind`, `CastPenalty`, `CastTestModsContext`, +11 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/weaponGroups.ts`, `src/engine/magic.ts`, +6 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.143-145) → `FocusInterruptHook`, `focalisation-etendue`, `dispel-roll`, `armourCastDRPenalty`, `runCombatFlow`, `focus-interrupt`, `createCombatSlice`, `CastPenalty`, `CastTestModsContext`, `castTestDRMods`, +11 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/weaponGroups.ts`, `src/engine/magic.ts`, +6 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.150-152) → `DispelModal`, `STEP_WINDOW_AUTO`, `FocusInterruptHook`, `focalisation-etendue`, `jetSurfaced`, `dispel-roll`, `armourCastDRPenalty`, `RollRowProps`, `runCombatFlow`, `assistBonus`, +53 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/weaponGroups.ts`, `src/engine/conditions.ts`, +22 fichiers
- `VDM 2` (l.5, l.169) → `schema`, `armourCastDRPenalty`, `armure-du-chaos`, `malevolentInfluenceSeverity`, `OPTIONAL_RULES`, `ItemInstance`, `TrappingData`, `WeaponGroupData`, `malepierreDR`, `malepierreCharge`, +4 — `src/data/index.ts`, `src/data/schemas/defs/trappings.ts`, `src/data/trappings.json`, `src/data/weaponGroups.json`, `src/engine/magic.ts`, `src/engine/policy.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.108-110) → `AuContactModal`, `GrappleModal`, `entityBlockedAt`, `useAttackJetProps`, `useDefenseJetProps`, `sur-la-defensive`, `DisengageModal`, `BattleState`, `OPTIONAL_RULES`, `pushCommitTile`, +6 — `src/data/regles.json`, `src/engine/policy.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`, `src/state/sceneRules.ts`, `src/state/store.ts`, +7 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.159-162) → `DispelModal`, `vents-tres-forts`, `STEP_WINDOW_AUTO`, `useHoverTargeting`, `focalisation-etendue`, `jetSurfaced`, `dispel-roll`, `armourCastDRPenalty`, `RollRowProps`, `assistBonus`, +57 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/weaponGroups.ts`, `src/data/vents-tourbillonnants.json`, +24 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.92-94) → `overcastAxes`, `combat-spell-plus`, `missileComponent`, `lecture-au-grimoire`, `missileOvercastDamageBonus`, `miscast-table`, `canCastFromGrimoire`, `malevolentInfluenceSeverity`, `CastPenalty`, `incantation-imparfaite`, +3 — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/overcast.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.96-99) → `followsCharacterRules`, `overcastAxes`, `combat-spell-plus`, `missileComponent`, `lecture-au-grimoire`, `missileOvercastDamageBonus`, `miscast-table`, `canCastFromGrimoire`, `malevolentInfluenceSeverity`, `CastPenalty`, +5 — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/overcast.ts`, +4 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.133) → `useDefenseJetProps`, `useHoverTargeting`, `useAttackJetProps`, `FLOWS`, `chooseEnemyAction`, `attackEnv`, `outOfSightTargetIds`, `rangedDefenseModes`, `GameState`, `attackPlan`, +2 — `src/data/localisation.json`, `src/engine/combat.ts`, `src/gameIso/stage/useHoverTargeting.ts`, `src/state/ai.ts`, `src/state/combatFlow.ts`, `src/state/combatSlice.ts`, +4 fichiers
- `LDB 46` (l.101-105) → `followsCharacterRules`, `overcastAxes`, `combat-spell-plus`, `missileComponent`, `lecture-au-grimoire`, `missileOvercastDamageBonus`, `miscast-table`, `canCastFromGrimoire`, `CastPenalty`, `incantation-imparfaite`, +2 — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/overcast.ts`, +3 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.107-114) → `followsCharacterRules`, `overcastAxes`, `combat-spell-plus`, `CastableSpell`, `missileComponent`, `lecture-au-grimoire`, `missileOvercastDamageBonus`, `miscast-table`, `canCastFromGrimoire`, `castingBaseValue`, +12 — `src/data/combat-stakes.json`, `src/data/regles.json`, `src/engine/grimoire.ts`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/overcast.ts`, +6 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.123-124) → `combat-spell-plus`, `CastableSpell`, `focalisation-etendue`, `lecture-au-grimoire`, `miscast-table`, `dispel-roll`, `castingBaseValue`, `castingValue`, `BattleState`, `focus-interrupt`, +13 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/regles.json`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, +4 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 46` (l.122-126) → `combat-spell-plus`, `CastableSpell`, `focalisation-etendue`, `lecture-au-grimoire`, `miscast-table`, `dispel-roll`, `castingBaseValue`, `castingValue`, `BattleState`, `focus-interrupt`, +15 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/regles.json`, `src/engine/magic.ts`, `src/engine/miscast.ts`, `src/engine/types.ts`, +5 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 48` (l.11) → `forme-bestiale`, `incarnation-de-wyssan`, `hemorragique`, `langue-bestiale`, `maitre-de-la-bete` — `src/data/spells.json`, `src/engine/domainAttributes.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 48` (l.7) → `forme-bestiale`, `incarnation-de-wyssan`, `hemorragique`, `langue-bestiale`, `maitre-de-la-bete` — `src/data/spells.json`, `src/engine/domainAttributes.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 48` (l.105) → `maitre-de-la-bete`, `peau-de-chasseur`, `hemorragique`, `aveugle`, `bouclier-ceruleen` — `src/data/spells.json`, `src/engine/domainAttributes.ts`
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 48` (l.679-689) → `domainEnvironmentBonus`, `setEnvironment`, `Scene`, `FLOWS`, `DomainData`, `castContextMods`, `peur`, `illusion`, `jumeau-malefique`, `linceul-d-invisibilite`, +8 — `src/data/index.ts`, `src/data/spells.json`, `src/engine/domainAttributes.ts`, `src/state/combatFlow.ts`, `src/state/rollFlowSpecs.ts`, `src/state/scene.ts`, +1 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 47` (l.28) → `CastingNumberRounding`, `SpellTarget`, `CastModal`, `zoneDiameterMultiplier`, `carriedGrimoire`, `SpellbookSection`, `overcastAffordance`, `FLOWS`, `ItemCapabilities`, `GameState`, +12 — `src/data/index.ts`, `src/engine/castingNumber.ts`, `src/engine/grimoire.ts`, `src/engine/overcast.ts`, `src/engine/spellRange.ts`, `src/gameIso/stage/ZdeTemplate.tsx`, +8 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 19` (l.40, l.51-53) → `CorruptionModal`, `sombre-pacte`, `combat-end-corruption`, `EXPOSURE_LADDER`, `physique`, `schema`, `corruption-mineure`, `corruption-moderee`, `corruption-majeure`, `corruption-seuil`, +13 — `src/data/characteristics.json`, `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/mutationTables.json`, `src/data/regles.json`, `src/data/schemas/defs/arcane-phenomena.ts`, +8 fichiers
- `LDB 44` (l.113-119) → `schema` — `src/data/schemas/defs/trappings.ts`
- `LDB 46` (l.164-173) → `DispelModal`, `windsModFromRoll`, `FocusModal`, `vents-tres-forts`, `rollWindsOfMagic`, `STEP_WINDOW_AUTO`, `schema`, `windsMagicModOf`, `useHoverTargeting`, `focalisation-etendue`, +72 — `src/data/combat-stakes.json`, `src/data/donnees.manifest.json` ⚠hors-app, `src/data/flow-stakes.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/schemas/defs/species.ts`, +33 fichiers
...
- `LDB 49` (l.5-7) → `MiscastResult`, `rollMiscast`, `OPTIONAL_RULES`, `liveSinPoints`, `sorceryCorruptionLines`, `finishMiscast` — `src/engine/miscast.ts`, `src/engine/policy.ts`, `src/state/combatFlow.ts`
