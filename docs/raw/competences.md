...
- `LDB 9` (l.12-18) → `RecoverResolution`, `possesses`, `DispelModal`, `useTestJetProps`, `AppraiseModalView`, `BargainModalView`, `HealRollFlow`, `TestResult`, `SurgeryRollFlow`, `rollTest`, +27 — `src/engine/axes.ts`, `src/engine/combat.ts`, `src/engine/magic.ts`, `src/engine/skillCombatApps.ts`, `src/engine/skills.ts`, `src/engine/tests.ts`, +18 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 9` (l.255-269) → `altCharKey`, `carryOverState`, `healDifficulty`, `healWoundsDelta`, `stopBleedOutcome`, `HealWoundsOptions`, `applyHealWounds`, `heal-wounds`, `emprise-sur-les-animaux`, `heal-bleed`, +7 — `src/data/flow-stakes.json`, `src/data/reglesOptionnelles.json`, `src/data/skills.json`, `src/engine/healing.ts`, `src/engine/persistence.ts`, `src/engine/skills.ts`, +2 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 9` (l.272-294) → `altCharKey`, `healDifficulty`, `heal-wounds`, `heal-bleed`, `skill-advantage`, `guerison`, `intimidation`, `intuition`, `noir-parler`, `createCombatSlice` — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/reglesOptionnelles.json`, `src/data/skills.json`, `src/engine/healing.ts`, `src/engine/skills.ts`, +1 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 9` (l.293-294, l.358) → `altCharKey`, `heal-wounds`, `heal-bleed`, `skill-advantage`, `guerison`, `intimidation`, `intuition`, `noir-parler`, `marchandage`, `vigneron`, +2 — `src/data/combat-stakes.json`, `src/data/flow-stakes.json`, `src/data/reglesOptionnelles.json`, `src/data/skills.json`, `src/engine/skills.ts`
- `ADE II 2` (l.728) → `altCharKey`, `castingCharKey`, `possession-pas-a-sa-taille`, `gueule`, `DomainData`, `ogre`, `bouf-crane`, `broyeur-d-os`, `festin-des-damnes` — `src/data/domains.json`, `src/data/index.ts`, `src/data/regles.json`, `src/data/spells.json`, `src/data/traits.json`, `src/engine/magic.ts`, +1 fichiers
