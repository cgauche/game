...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.133, l.135, l.137-145, l.147, l.153, l.159) → `useDefenseJetProps`, `engage`, `useHoverTargeting`, `useAttackJetProps`, `defenseSurfaced`, `Condition`, `FLOWS`, `chooseEnemyAction`, `attackEnv`, `createCombatSlice`, +8 — `src/data/localisation.json`, `src/engine/combat.ts`, `src/engine/engagement.ts`, `src/engine/flowCore.ts`, `src/engine/types.ts`, `src/gameIso/stage/useHoverTargeting.ts`, +8 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.114, l.125, l.133, l.137-145) → `useDefenseJetProps`, `useHoverTargeting`, `entityBlockedAt`, `useAttackJetProps`, `defenseSurfaced`, `sur-la-defensive`, `BattleState`, `OPTIONAL_RULES`, `FLOWS`, `chooseEnemyAction`, +11 — `src/data/localisation.json`, `src/data/regles.json`, `src/engine/combat.ts`, `src/engine/policy.ts`, `src/gameIso/stage/useHoverTargeting.ts`, `src/state/ai.ts`, +10 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.117-118) → `useDefenseJetProps`, `useHoverTargeting`, `entityBlockedAt`, `defenseSurfaced`, `sur-la-defensive`, `OPTIONAL_RULES`, `FLOWS`, `chooseEnemyAction`, `attackEnv`, `ActionBar`, +6 — `src/data/localisation.json`, `src/data/regles.json`, `src/engine/policy.ts`, `src/gameIso/stage/useHoverTargeting.ts`, `src/state/ai.ts`, `src/state/combatFlow.ts`, +7 fichiers
...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 13` (l.132-153) → `useDefenseJetProps`, `useHoverTargeting`, `useAttackJetProps`, `defenseSurfaced`, `Condition`, `FLOWS`, `chooseEnemyAction`, `attackEnv`, `createCombatSlice`, `outOfSightTargetIds`, +5 — `src/data/localisation.json`, `src/engine/combat.ts`, `src/engine/flowCore.ts`, `src/gameIso/stage/useHoverTargeting.ts`, `src/state/ai.ts`, `src/state/combatFlow.ts`, +6 fichiers
