...
**Implémente :** _(généré — `npm run raw:implemente`)_
- `LDB 40` (l.56, l.60-61, l.70, l.71-72, l.82, l.86, l.87-88, l.90, l.94-95, l.99, l.101) → `NestedTest`, `liveTableDecl`, `wrath-table`, `peche`, `CastPenalty`, `sonne`, `colere-pensez-a-vos-actes`, `CascadeActorCounter`, `colere-tenez-compte-de-mes-enseignements`, `a-terre`, +27 — `src/data/characteristics.json`, `src/data/combat-stakes.json`, `src/data/miscast.json`, `src/engine/miscast.ts`, `src/engine/prayer.ts`, `src/engine/types.ts`, +3 fichiers
