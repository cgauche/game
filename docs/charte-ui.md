...
| `.rm-note` | Note secondaire d'une modale de jet (enjeu d'une étape, acte de soin en cours, cadence d'un Test étendu, opposition annulée) | Rangée flex à alignement HAUT : accepte une icône + une `<Prose>` de bloc (dont les paragraphes perdent leur marge propre). Partagée par 7 modales — jamais redéfinie dans un module de domaine. |
