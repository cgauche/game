...
Identités indexées : **5962** (entrées de racine + documents embarqués) ; libellés
normalisés : **5200**. Un id vu dans PLUSIEURS datasets rend la résolution
...
| `src/data/primitives.manifest.json` | array | liste | entité | 96 | `concept`:string(96) `css`:string(47) `fichier`:string(96) `id`:string(96) `label`:string(96) `nature`:string(5) `perimetre`:string(96) `poseurs`:array(11) `type`:string(96) `verrou`:string(96) |
...
| `concept,fichier,id,label,perimetre,type,verrou` | 49 |
...
Lignes concept × dataset × champ × forme : **881** (cible 404 · declaree 6 · historique 131 · divergente 340). Objets JSON parcourus : **49522**, dont **32333** portent une forme
mesurée. Champs porteurs de référence MESURÉS : **90**.

Entrées de racine sans concept de valeur : **4137** sur **4224** —
...
Au-delà des orphelines, **13197** objets sur **49522** ne sont portés par AUCUNE
...
<!-- sources-empreinte: cdd476f58d71f36f999ea01ff2c2ac7731a27339 (380 fichiers, 10 dossiers) corps: f6847fff05416eb42ba4db938154a4e7b08cd29c -->
