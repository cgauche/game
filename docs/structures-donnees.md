...
Identités indexées : **5961** (entrées de racine + documents embarqués) ; libellés
normalisés : **5199**. Un id vu dans PLUSIEURS datasets rend la résolution
...
| `src/data/primitives.manifest.json` | array | liste | entité | 95 | `concept`:string(95) `css`:string(47) `fichier`:string(95) `id`:string(95) `label`:string(95) `nature`:string(5) `perimetre`:string(95) `poseurs`:array(11) `type`:string(95) `verrou`:string(95) |
...
<!-- sources-empreinte: 79be44f7c874ae30e3453e29bbb3cc8889deaaaa (380 fichiers, 10 dossiers) corps: 38940a387932a4e3791422454eaff03b5be95d5e -->
