...
Identités indexées : **5960** (entrées de racine + documents embarqués) ; libellés
normalisés : **5198**. Un id vu dans PLUSIEURS datasets rend la résolution
AMBIGUË (jamais fausse) : **402** collisions, et **3468** ids
...
| `src/data/primitives.manifest.json` | array | liste | entité | 94 | `concept`:string(94) `css`:string(46) `fichier`:string(94) `id`:string(94) `label`:string(94) `nature`:string(4) `perimetre`:string(94) `poseurs`:array(11) `type`:string(94) `verrou`:string(94) |
...
Lignes concept × dataset × champ × forme : **881** (cible 404 · declaree 6 · historique 131 · divergente 340). Objets JSON parcourus : **49518**, dont **32333** portent une forme
mesurée. Champs porteurs de référence MESURÉS : **90**.

Entrées de racine sans concept de valeur : **4135** sur **4222** —
...
Au-delà des orphelines, **13195** objets sur **49518** ne sont portés par AUCUNE
...
<!-- sources-empreinte: e8f1247d88ed103a208fcbef7329a213100faab2 (380 fichiers, 10 dossiers) corps: 874e58b728cbcf644534a0000f4a7e353a5ba710 -->
