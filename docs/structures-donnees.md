...
Littéraux d’objet zod lus : **499** ; **110** recoupent le lexique
...
| `axes.ts` | 20 | — | reference | historique | `skillId,spec` | — |
...
| `structures.ts` | 18 | — | reference | historique | `id,value` | — |
