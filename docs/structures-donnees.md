...
Identités indexées : **5959** (entrées de racine + documents embarqués) ; libellés
normalisés : **5197**. Un id vu dans PLUSIEURS datasets rend la résolution
...
| `src/data/primitives.manifest.json` | array | liste | entité | 93 | `concept`:string(93) `css`:string(45) `fichier`:string(93) `id`:string(93) `label`:string(93) `nature`:string(4) `perimetre`:string(93) `poseurs`:array(11) `type`:string(93) `verrou`:string(93) |
...
| `concept,css,fichier,id,label,perimetre,type,verrou` | 32 |
...
Lignes concept × dataset × champ × forme : **881** (cible 404 · declaree 6 · historique 131 · divergente 340). Objets JSON parcourus : **49517**, dont **32333** portent une forme
...
Au-delà des orphelines, **13195** objets sur **49517** ne sont portés par AUCUNE
...
<!-- sources-empreinte: 1865030e4dd2de1ebaac1926c31970ab0568651d (380 fichiers, 10 dossiers) corps: 42c55214edcc0357a8b131ff7c39a8908e86d040 -->
