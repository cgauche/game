...
Identités indexées : **5969** (entrées de racine + documents embarqués) ; libellés
normalisés : **5207**. Un id vu dans PLUSIEURS datasets rend la résolution
AMBIGUË (jamais fausse) : **402** collisions, et **3471** ids
...
| `src/data/primitives.manifest.json` | array | liste | entité | 102 | `concept`:string(102) `css`:string(47) `fichier`:string(102) `id`:string(102) `label`:string(102) `nature`:string(5) `perimetre`:string(102) `poseurs`:array(11) `type`:string(102) `verrou`:string(102) |
...
Lignes concept × dataset × champ × forme : **881** (cible 404 · declaree 6 · historique 131 · divergente 340). Objets JSON parcourus : **49939**, dont **32498** portent une forme
mesurée. Champs porteurs de référence MESURÉS : **91**.

Entrées de racine sans concept de valeur : **4144** sur **4231** —
...
495 ligne(s), 24966 occurrence(s).
...
Au-delà des orphelines, **13456** objets sur **49939** ne sont portés par AUCUNE
...
<!-- sources-empreinte: 6b7cd709ab9ee3a3c02f492fa783a18909756712 (386 fichiers, 10 dossiers) corps: 827e6d43142934713f8c6a291d6f3c41c4f688c6 -->
