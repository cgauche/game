...
Identités indexées : **5802** (entrées de racine + documents embarqués) ; libellés
normalisés : **5031**. Un id vu dans PLUSIEURS datasets rend la résolution
AMBIGUË (jamais fausse) : **385** collisions, et **3364** ids
