...
| `intoxicate` | — | exécutée | `engine/drunkenness.ts` | 3 — `tavernGames.json:cerevis`, `trappings.json:biere-pinte` … | Boisson alcoolisée : enregistre UN échec de Résistance à l'alcool (LDB 09 l.475) sur la cible — −10 aux CC/CT/Ag/Dex/Int (plafond −30), et Ivresse (1d10) au seuil BE. |
