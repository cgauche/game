...
(`24` fichier(s) exempt(s) sur `121`). Aucune de ces valeurs n'est écrite ici :
...
- **`variants?: Variant[]`** (#563/#564) — variante RÉGLÉE d'une entrée sous une **règle optionnelle**
  ...
  - `desc`/`source` — Codex, `effectiveEntry`, `src/ui/compendium/registry.ts:1466`
  ...
  - `desc`/`source` — Codex, `effectiveEntry`, `src/ui/compendium/registry.ts:590`
...
<!-- sources-empreinte: 868520ea7200360d56a7de535cebd28702d3a75c (359 fichiers, 2 dossiers) corps: e2cafb54f99abcf943696479ea33804dbbe205ed -->
