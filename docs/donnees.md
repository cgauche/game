...
- **`variants?: Variant[]`** (#563/#564) — variante RÉGLÉE d'une entrée sous une **règle optionnelle**
  ...
  - `desc`/`source` — Codex, `effectiveEntry`, `src/ui/compendium/registry.ts:1507`
  ...
  - `desc`/`source` — Codex, `effectiveEntry`, `src/ui/compendium/registry.ts:589`
...
<!-- sources-empreinte: bb5084b6838977d91b7f4c574cfb981f5813898e (358 fichiers, 2 dossiers) corps: 48a48fab827f863e6a4a7295041fe9cb82741d60 -->
