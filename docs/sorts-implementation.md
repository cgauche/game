...
| Les lunes du chasseur | 🟡 | oui | Les lunes du chasseur : seules les cibles ALLIÉES situées dans la Zone d'Effet en bénéficient — le filtre d'alliance n'est pas modélisé, arbitrage MJ. |
...
| Obstination du bœuf | 🟡 | oui | Obstination du bœuf : seuls vos alliés situés dans la Zone d'Effet sont encouragés, et ils n'ont pas besoin d'effectuer de Test de Peur ou de Terreur pendant la Durée du Sort — dispense de Test de Peur/Terreur non modélisée, arbitrage MJ. |
...
| Régiment monstrueux de Merciw | 🟡 | oui | Régiment monstrueux de Merciw : seuls vos alliés situés dans la Zone d'Effet reçoivent le bonus, plafonné à 100 en Force comme en Endurance — plafond de Caractéristique non modélisé, arbitrage MJ. |
...
| Distorsion temporelle | 🟡 | oui | Distorsion temporelle : tous les personnages alliés de la Zone d'Effet reçoivent une Action supplémentaire (sans Mouvement supplémentaire), résolue par ordre d'Initiative en ignorant ennemis et neutres, puis l'initiative reprend au personnage qui vous suit — Action supplémentaire non modélisée, arbitrage MJ. |
...
| Aperçu de la mort | 🟡 | oui | Aperçu de la mort : la victime reçoit en plus le Trait Psychologique (Désespoir) et, dans la semaine qui suit, un État Exténué à chaque réveil matinal — Trait Psychologique nommé mais non défini par la source, arbitrage MJ. Aperçu de la mort : les ennemis vivants situés à (Bonus d'Initiative) mètres de la cible principale doivent réussir un Test de Calme Accessible (+20) ou recevoir un État Sonné, et ceux qui échouent enchaînent le Test de Calme Facile (+40) ci-dessus — Zone d'Effet centrée sur la cible principale non modélisée, arbitrage MJ. |
