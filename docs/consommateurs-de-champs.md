...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 3 | `src/data/index.ts:3221` |
| `spec` | 1 | `src/data/index.ts:3222` |

### `QualityRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 1 | `src/data/index.ts:3233` |
| `spec` | **0 — JAMAIS LU** | — |
| `value` | 2 | `src/data/index.ts:3233` |
...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 4 | `src/data/index.ts:3279` |
| `spec` | 1 | `src/engine/trappingChoices.ts:36` |
| `count` | 3 | `src/data/index.ts:3280` |
| `qualities` | 2 | `src/data/index.ts:3283` |
| `qualityChoice` | 2 | `src/data/index.ts:3281` |
| `text` | 1 | `src/data/index.ts:3274` |
| `vehicleId` | 2 | `src/data/index.ts:3276` |
| `label` | **0 — JAMAIS LU** | — |
| `creatureId` | 2 | `src/data/index.ts:3278` |
| `choice` | 3 | `src/data/index.ts:3271` |
| `wildcard` | 1 | `src/data/index.ts:3272` |

### `AdvancementRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `ref` | 4 | `src/data/index.ts:3253` |
| `wildcard` | 5 | `src/data/index.ts:3255` |
| `specOptions` | 3 | `src/data/index.ts:3254` |
| `choice` | 4 | `src/data/index.ts:3257` |
| `random` | 2 | `src/data/index.ts:3258` |
