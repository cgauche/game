...
| `sense` | 1 | `src/state/combatEffects.ts:371` |
| `characteristic` | 8 | `src/state/combat/triggeredTest.ts:176` |
| `difficulty` | 2 | `src/engine/flowCore.ts:367` |
| `requireSL` | 1 | `src/state/combatEffects.ts:393` |
| `label` | 2 | `src/state/combat/triggeredTest.ts:181` |
| `tool` | 1 | `src/state/combatEffects.ts:373` |
| `vsGroups` | 3 | `src/state/combatEffects.ts:318` |
| `vsStatus` | 1 | `src/state/combatEffects.ts:317` |
| `begging` | 2 | `src/state/combatEffects.ts:322` |
| `vsCapricieux` | 1 | `src/state/combatEffects.ts:326` |
| `easierIf` | 4 | `src/state/combatEffects.ts:348` |
