...
| `spec` | 18 | `src/data/index.ts:3545` |

### `QualityRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 5 | `src/data/index.ts:3557` |
...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 8 | `src/data/index.ts:3599` |
| `spec` | 2 | `src/engine/careerSlots.ts:170` |
| `choix` | 7 | `src/data/index.ts:3023` |
| `pick` | 2 | `src/data/index.ts:3602` |
| `of` | 6 | `src/data/index.ts:3601` |
| `table` | — | *absent du type TS* |
| `random` | 3 | `src/data/index.ts:3604` |
...
| `volume` | 18 | `src/data/index.ts:2795` |
...
<!-- sources-empreinte: d2d9cd72f5661534f8b6548ff7f3fd94e70a1a7b (2093 fichiers, 169 dossiers) corps: b18fa2438d64d04d634be6d58b52eac7030f4e1a -->
