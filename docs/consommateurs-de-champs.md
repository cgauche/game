...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 179 | `src/data/index.ts:3036` |
| `spec` | 108 | `src/data/index.ts:3566` |

### `QualityRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 6 | `src/data/index.ts:3579` |
| `value` | 4 | `src/data/index.ts:3580` |
...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `fixed` | 4 | `src/data/index.ts:3648` |
| `roll` | 3 | `src/data/index.ts:3648` |
...
| `count` | 10 | `src/data/index.ts:3648` |
| `qualities` | 4 | `src/data/index.ts:3651` |
| `qualityChoice` | 6 | `src/data/index.ts:3649` |
| `text` | 2 | `src/data/index.ts:3642` |
| `vehicleId` | 5 | `src/data/index.ts:3644` |
| `label` | 7 | `src/engine/possessionGrants.ts:25` |
| `creatureId` | 5 | `src/data/index.ts:3646` |
| `choice` | 5 | `src/data/index.ts:3639` |
| `wildcard` | 3 | `src/data/index.ts:3640` |

### `AdvancementRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 9 | `src/data/index.ts:3621` |
| `spec` | 3 | `src/engine/careerSlots.ts:177` |
| `choix` | 7 | `src/data/index.ts:3036` |
| `pick` | 2 | `src/data/index.ts:3624` |
| `of` | 6 | `src/data/index.ts:3623` |
| `table` | — | *absent du type TS* |
| `random` | 3 | `src/data/index.ts:3626` |
...
<!-- sources-empreinte: b81af53353697657c400dba6cc03bb25c5293f76 (2101 fichiers, 172 dossiers) corps: b98516b8e6736c238450548b9b88fe59a5983257 -->
