...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 62 | `src/data/index.ts:3028` |
| `spec` | 22 | `src/data/index.ts:3517` |
...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 13 | `src/data/index.ts:3571` |
| `spec` | 3 | `src/engine/careerSlots.ts:168` |
| `choix` | 9 | `src/data/index.ts:3028` |
...
<!-- sources-empreinte: ff2d7368be2854753d3007d270f6323687ca7823 (2108 fichiers, 174 dossiers) corps: cfbed4d291b8e5ff3b5c4a6c47d0847c95992ec3 -->
