...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 62 | `src/data/index.ts:3004` |
| `spec` | 18 | `src/data/index.ts:3526` |

### `QualityRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 5 | `src/data/index.ts:3538` |
| `value` | 4 | `src/data/index.ts:3539` |
...
| Champ | Lecteurs | Exemple |
|---|---|---|
| `fixed` | 4 | `src/data/index.ts:3607` |
| `roll` | 3 | `src/data/index.ts:3607` |
...
| `count` | 10 | `src/data/index.ts:3607` |
| `qualities` | 4 | `src/data/index.ts:3610` |
| `qualityChoice` | 6 | `src/data/index.ts:3608` |
| `text` | 2 | `src/data/index.ts:3601` |
| `vehicleId` | 5 | `src/data/index.ts:3603` |
| `label` | 7 | `src/engine/possessionGrants.ts:25` |
| `creatureId` | 5 | `src/data/index.ts:3605` |
| `choice` | 5 | `src/data/index.ts:3598` |
| `wildcard` | 3 | `src/data/index.ts:3599` |

### `AdvancementRef` (src/data/index.ts)

| Champ | Lecteurs | Exemple |
|---|---|---|
| `id` | 8 | `src/data/index.ts:3580` |
| `spec` | 2 | `src/engine/careerSlots.ts:170` |
| `choix` | 7 | `src/data/index.ts:3004` |
| `pick` | 2 | `src/data/index.ts:3583` |
| `of` | 6 | `src/data/index.ts:3582` |
| `table` | — | *absent du type TS* |
| `random` | 3 | `src/data/index.ts:3585` |
...
| `volume` | 18 | `src/data/index.ts:2778` |
...
<!-- sources-empreinte: 7bb9c557f197536aaacb52938286d07fcae8d45e (2086 fichiers, 169 dossiers) corps: ee632a26a8f9b5b6aafcfeb97e042c2852e51185 -->
