...
| `src/state/store.ts` | 1 | canonique | 2850 | canonique : re-ciblage d'un `pendingTest` EXISTANT (`{ ...pt, … }`) sur un autre candidat — `target` recopié du candidat DÉJÀ calculé par la fabrique, aucun jet neuf décrit. |
...
<!-- sources-empreinte: 23bc8be6173ecfd5d71f6a6817488d46dc41b5ab (2111 fichiers, 136 dossiers) corps: 642d4b32c1242d3a49e345c3b4c97f1773692a3d -->
