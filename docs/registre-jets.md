...
| `src/state/store.ts` | 1 | canonique | 2827 | canonique : re-ciblage d'un `pendingTest` EXISTANT (`{ ...pt, … }`) sur un autre candidat — `target` recopié du candidat DÉJÀ calculé par la fabrique, aucun jet neuf décrit. |
...
<!-- sources-empreinte: e338c8c65f5244554bab60f58b459f1df4f4d220 (2079 fichiers, 134 dossiers) corps: 186cb536f31fc458fe9572aa6a99b0c30cedaeeb -->
