...
| `src/state/combatFlow.ts` | 2 | mixte | 3371, 7982 | 1 gate de main (`pendingHandGate`, `openAttackCascade`) monté à la main -> #1064 ; 1 `PendingReload` d'ennemi construit APRÈS un `rollSansPilote` déjà scellé — canonique : objet de RENDU (journal/popin), aucun jet à ouvrir. |
...
| `src/state/massBattleFlow.ts` | 1 | dette | 349 | `openBattleActivity` — fabrique PARTAGÉE, atteinte par 6 call-sites (prep ×3/round ×2/resistance) -> #1067 (surfaçage massBattle). |
...
<!-- sources-empreinte: 5b6d78a8439f54d50c4f285313139f6ff59c0319 (2104 fichiers, 134 dossiers) corps: f38262babad649404e885784bd12f16899e531d2 -->
