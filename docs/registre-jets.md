...
| `src/state/combatFlow.ts` | 2 | mixte | 3189, 7512 | 1 gate de main (`pendingHandGate`, `openAttackCascade`) monté à la main -> #1064 ; 1 `PendingReload` d'ennemi construit APRÈS un `rollSansPilote` déjà scellé — canonique : objet de RENDU (journal/popin), aucun jet à ouvrir. |
...
_87 call-sites mesurés dans 21 fichiers, pour 84 exports rouleurs dérivés de `src/engine` — par nature : 55 mixte, 17 dette, 15 canonique._
...
<!-- sources-empreinte: 1f5cca1bcc63922d2f3a52392b5ab02a035337b3 (1960 fichiers, 137 dossiers) -->
