...
scenes.push(scene({
  ...
  entities: [
    ...
    NPC('kramer', 11, 3, 'Dame Vasilika Kramer', { facing: 'S', dialogueId: 'dlg-kramer', appearance: { species: 'Humains (Kislevite)', career: 'Marchande', sex: 'F', build: 0.45 } }),
...
scenes.push(scene({
  ...
  entities: [
    hero(2, 4),
    NPC('docker', 7, 3, 'Docker du port', { facing: 'S', dialogueId: 'dlg-rumeur-olg', appearance: { species: 'Humains (Kislevite)', career: 'Ouvrier', sex: 'M', build: 0.6 } }),
    NPC('kramer-erengrad', 11, 3, 'Dame Vasilika Kramer', { facing: 'S', dialogueId: 'dlg-kramer-nuit-du-chat', appearance: { species: 'Humains (Kislevite)', career: 'Marchande', sex: 'F', build: 0.45 } }),
