...
WEAPONS.forEach((name, r) => {
  ...
  cols.forEach((col, ci) => {
    const inner = renderToStaticMarkup(React.createElement(RigSprite, { appearance: { species: 'Humain', sex: 'M', build: 0.5, seed: 4 }, equip: { weapons: [w], armour: [] }, career: 'Soldat', view: 'front', pose: col.pose }));
