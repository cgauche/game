...
// retombe sur « nu » rendrait un rat nu au lieu de l'armure de récup (#1338).
const TENUE_SKAVEN = 'skaven';
...
VIEWS.forEach((view, i) => {
  const inner = bonesToSvg(resolveRig(appearance, equip, {}, TENUE_SKAVEN, view));
