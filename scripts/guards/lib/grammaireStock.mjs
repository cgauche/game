...
export const GRAMMAIRE_STOCK = {
  ...
  'src/data/schemas/defs/sea-cargo.ts:schema.opportunite.test|alias|skillId': e('Test d’opportunité de cargaison maritime en `{skillId, …}` (`STRUCTURES_REDECLARATIONS` sea-cargo.ts).', L2),
  ...
  'src/data/schemas/defs/sea-perils.ts:schema.tourbillonSwim|alias|skillId': e('Test de Natation du tourbillon en `{skillId, …}` (`STRUCTURES_REDECLARATIONS` sea-perils.ts).', L2),
  ...
  'src/data/schemas/defs/water-exposure.ts:schema.test|alias|skillId': e('Test d’exposition à l’eau en `{difficulty, skillId}` (`STRUCTURES_REDECLARATIONS` water-exposure.ts).', L2),
  ...
  'src/data/schemas/defs/river-perils.ts:schema.perils|alias|ref': e('Péril fluvial désignant son entité (créature/structure) par une enveloppe `ref`.', L3),
