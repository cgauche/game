...
export const EXEMPT_DATASETS = {
  ...
  'materials.json':
    'catalogue des MATIÈRES du monde (décor volumique, toiture, relief — couleur, réponse à la lumière, recettes de détail de surface) : apparence de rendu, aucune règle à citer.',
