 ...
 *  `#1553` sinon : une orpheline se solde en CURANT le CONTENU (la valeur pointe vers rien), pas en
 *  posant une enveloppe. Les 92 lignes de ce volet ne sont donc PAS du ressort de `L1b #1467`, dont
 *  le dénominateur (205) les comptait ; elles portent leur lot ligne à ligne. */
