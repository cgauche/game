...
export const STRUCTURES_FORMES = [
  ...
  { concept: "test", dataset: "criticals.json", champ: "test", signature: "difficulty", statut: "divergente", strate: "Valeur", occurrences: 38, lot: "L4 #1463", date: "2026-08-23" },
  { concept: "test", dataset: "criticals.json", champ: "test", signature: "difficulty,skill", statut: "historique", strate: "Valeur", occurrences: 1, lot: "L4 #1463", date: "2026-08-23" },
