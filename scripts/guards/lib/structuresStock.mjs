...
export const STRUCTURES_FORMES = [
  ...
  { concept: "reference", dataset: "combat-stakes.json", champ: "rule", signature: "id-nu", statut: "historique", strate: "Référence", occurrences: 24, lot: "L3 #1463", date: "2026-08-30", motif: "référence de RÈGLE" }, // 23 → 24 (#1657 B3-1) : l'enjeu `critRowTest` de la rangée de Critique nomme son foyer
