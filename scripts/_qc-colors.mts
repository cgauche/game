...
const CASES: { label: string; app: Appearance }[] = [
  { label: 'Lézard défaut (vert)', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, monster: { tete: 'lezard' } } },
  { label: 'Lézard peau bleue', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, monster: { tete: 'lezard' }, colors: { peau: '#3f6fb0' } } },
  { label: 'Lézard peau rouge', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, monster: { tete: 'lezard' }, colors: { peau: '#a83838' } } },
  { label: 'Chien défaut (fauve)', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, monster: { tete: 'chien' } } },
  { label: 'Chien peau grise', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, monster: { tete: 'chien' }, colors: { peau: '#8a8f96' } } },
  { label: 'Mendiant + peau verte', app: { species: asRigSpeciesId('humain'), sex: 'M', build: 0.5, seed: 4, colors: { peau: '#5d7a42' } } },
];
