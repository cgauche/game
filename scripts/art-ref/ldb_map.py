...
Usage (le PDF vient de la CLI de la couture `pdfDe`, scripts/raw/pdf-de.mjs ; sortie par défaut art-ref/ldb) :
    python scripts/art-ref/ldb_extract.py --pdf "$(node scripts/raw/pdf-de.mjs livre-de-base)"   # d'abord
    python scripts/art-ref/ldb_map.py --pdf "$(node scripts/raw/pdf-de.mjs livre-de-base)" [--out PATH]
"""
import argparse
import json
import os
