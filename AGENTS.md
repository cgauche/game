...
- **user-arbitrage-stations-a-bord-deux-rosters-empiles** (2026-09-04, 3 verbatims) : « un poste par ligne, des portraits dans la case, [ + ] pour ajouter, poste fermé grisé avec raison au survol » — `.claude/memory/user-arbitrage-stations-a-bord-deux-rosters-empiles.md`
