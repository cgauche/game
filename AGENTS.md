...
- **user-arbitrage-de-de-monde-affiche-comme-un-critique** (2026-08-23, 2 verbatims) : « Mais la réponse est forcement: biensur que tu l'affiche ! On affiche les jets de maladresse, de critique, alors pourquoi tu voudrais ne pas afficher les jets de météo si je controle l'environnement ? » — `.claude/memory/user-arbitrage-de-de-monde-affiche-comme-un-critique.md`
...
- **user-arbitrage-stations-a-bord-deux-rosters-empiles** (2026-09-04) : « Maquette B3-2b : où et comment le joueur épingle-t-il la STATION à bord … » — `.claude/memory/user-arbitrage-stations-a-bord-deux-rosters-empiles.md`
