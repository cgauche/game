...
- ✅ **Orientation-monde persistante — refonte (2026-06-07, livrée + poussée)** : l'orientation des persos
  ...
  `BodyToken` — `token`/`tokenNode`/`EntityToken` délèguent, 4 wrappers → 1. Legacy mort retiré au passage :
  chemin de rendu monolithique en combat, `hasCreatureViews`.)*
