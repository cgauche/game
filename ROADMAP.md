...
## ✅ Jalon 1.5 — Sous-système Taille *(T2→T6 + Localisation par forme + Nuée + Agrandir/Réduire LIVRÉS ; audit RAW propre — reste seulement Monture & Taille, qui demande un système de monture)*
...
- **Détails RAW restants** : **Monture & Taille** (`14` l.217-223) — nécessite un système de monture (cavalier+monture liés, Chevaucher, cibler l'un ou l'autre) → lot à part, plus gros. *(Queue/Langue : ✅ attaques de créature, Jalon 1. Immunité Psychologie : ✅ T5.)*
